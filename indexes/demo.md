...
200. [Secure Encrypted Ethernet End Nodes](#dm-secure-encrypt-eth-frdm-a-s32k344)
201. [Selfie Segmenter](#nxp-demo-experience-demos-list_scripts_machine_learning_selfie_segmenter)
202. [Serial Communication Using FLEXIO and RTD](#dm-uart-s32k344)
203. [Serial Terminal LED Control Using UART Driver](#dm-uart-button-s32k358)
204. [Servo Steering Control Using PWM](#dm-pwm-steering-control-frdm-a-s32k344)
205. [Simple HTTP Server with Remote Status Observation and Control](#dm-ethernet-server-s32k344)
206. [Smart CAN Gateway for Automotive Actuators](#dm-smart-can-gtwy-frdm-a-s32k312-m276)
207. [Smart Sensing Inhaler using Pressure and Tilt sensors](#dm-smart-sensing-inhaler)
208. [Smart lighting LED bulb using LPC860](#dm-lpc860-smart-lighting)
209. [SmartWatch Zephyr Demo](#apps_zephyr)
210. [Snoring Detection based on RT1060 powered by AI\ML](#dm-snoring-detection-based-on-rt1060)
211. [Startup Message via Serial Terminal Using UART Driver](#dm-uart-hello-s32k358)
212. [Tamper detection with low-power wakeup sensor using BLE wireless UART](#dm-tamper-detection-using-low-power-wakeup-sensor-over-ble)
213. [Temperature Acquisition and UART Reporting](#dm-adc-tempsense-uart-s32k358)
214. [Temperature Sensing and Plotting on FreeMASTER](#dm-adc-tempsense-freemaster-s32k358)
215. [Temperature monitor with Modbus and CAN running in zephyr](#dm-modbus-can-temp-monitor-frdm)
216. [Temperature sensor demo using FRDM-A-S32K344](#dm-temperature-monitor-lcd-frdm-a-s32k344)
217. [Text to Speech with audio playback based on MIMXRT700](#dm-text-to-speech-based-on-rt700)
218. [Thermostat Controller with Relay and UART Reporting](#dm-thermostat-relay-s32k118)
219. [This demo provides APIs to configure and read accurate temperature using P3T1085UK sensor](#dm-p3t1085uk-temperature-sensor-driver-with-demo-app)
220. [This example demonstrates FXLS89xxxF 3-axis accelerometer evaluation GUI using ISSDK and FreeMASTER](#dm-freemaster-fxls89xxxf-evaluation-gui-firmware)
221. [Time Series Studio powered, on-device learning Fan anomaly detection based on FRDM-MCXA156](#dm-tss-powered-on-device-learning-fan-anomaly-based-on-mcxa156)
222. [Touch Keypad Tuning on MCXN](#dm-mcxn-touch-keypad-tuning)
223. [Transmission Control Module On FRDM-A-S32K344](#dm-transmission-control-s32k344)
224. [UART Communication Example using RTD Drivers on FRDM-A-S32K312](#dm-uart-s32k312)
225. [UART Communication and LED Example on FRDM-A-S32K344](#dm-uart-button-s32k344)
226. [UART Status Monitoring with Button Control](#dm-uart-button-s32k356)
227. [UBX100 FreeMASTER evaluation GUI](#dm-ubx100-freemaster-gui)
228. [UBX100 RF toolbox application](#dm-ubx100-rf-toolbox-application)
229. [UBX100 flashloader demo application](#dm-ubx100-flashloader)
230. [UWB Nearby Interaction with phones](#dm-uwb-nearby-interaction-with-phones)
231. [UWB Presence Detection demo](#dm-uwb-presence-detection-demo)
232. [Using EZH to implement camera interface in lpc55 series mcu](#dm-lpc55s69-camera-interface-by-ezh)
233. [Using SmartDMA to implement camera interface in MCXN236](#dm-mcxn236-camera-interface-by-smartdma)
234. [Vehicle Comfort Control for FRDM-A-S32K344](#dm-vehicle-comfort-control-s32k344)
235. [Vehicle Lighting Control for Daylight and Hazard Signals](#dm-vehicle-lighting-signals-frdm-a-s32k344)
236. [Vehicle Lighting Control for Daylight and Hazard Signals on FRDM-A-S32K312](#dm-vehicle-lighting-signals-frdm-a-s32k312)
237. [Very simple serial bootloader for NXP MCU](#dm-nxp_mcu_easy_bootloader)
238. [Visual Heart Rate Monitor](#dm-visual-heart-rate-monitor-s32k312)
239. [Visualizing Sensor Data with FreeMASTER: Motion and Temperature](#dm-motion-temperature-freemaster-s32k358)
240. [Vital Health Signal Visual Monitor On FRDM-A-S32K344](#dm-vital-health-signal-visual-monitor-s32k344)
241. [Wake Up from Sleep Through Magnetic Detection](#dm-reed-low-power-s32k312)
242. [Wake Up from Sleep via GPIO Button Press](#dm-gpio-button-wakeup-s32k344)
243. [Weather Visual Monitor](#dm-weather-visual-monitor-s32k344)
244. [Wi-Fi Easy Connect (DPP) In-Band Provisioning Demo on RT1060EVKC with IW612](#dm-dpp-in-band-provisioning-rt1060-iw612)
245. [Wi-Fi Scan and Connectivity Demo on RW612BGA](#dm-wifi-set-up-ping)
246. [Wi-Fi Sensing using Sniffer on RW61x with Zephyr OS](#dm-wifi-sensing-using-sniffer-on-rw61x-with-zephyr-os)
247. [Wi-Fi connect using LCD interface on FRDM-MCXN947 using Wi-Fi expansion board FRDM-IW416-AW-AM510](#dm-wifi-lcd-connect-frdm-mcxn947)
248. [WiFi AP and BLE Peripheral on RDRW612BGA](#dm-wifi-ap-and-ble-peripheral-on-rdrw612bga)
249. [WiFi CLI M2 FRDM MCXN947](#dm-wifi-cli-frdm-mcxn947)
250. [WiFi provisioning using BLE on RT1170 EVKB using Wi-Fi Module Murata 2EL](#dm-wifi-provisioning-using-ble)
251. [Wireless Co-Processor Enabled Motor Control](#dm-mc-pmsm-ncp-frdm-mcxa156)
252. [Wireless RFTM Application for Performance Testing of RW612 board](#dm-wireless-rf-test-mode-demo)
253. [Write a file to microSD Card](#dm-sd-card-write-file-s32k356)
254. [[OOBE-MCXW71] Controlling LEDS using BLE Wireless UART](#dm-mcx-wireless-uart-leds)
255. [[RT1060 + IW416] MQTT client using Wi-Fi](#dm-wifi-sta-mqtt)
256. [afci 8ch mcxn547 demo](#dm-afci-8ch-mcxn547)
257. [demo project to use the module sCan](#dm-loc-apps-kw47)
258. [eIQ GenAI Flow Demonstrator](#dm-eiq-genai-flow-demonstrator)
259. [i.MX Driver Monitor System](#nxp-demo-experience-demos-list_scripts_machine_learning_dms)
260. [i.MX Machine Learning Benchmark Tool](#nxp-demo-experience-demos-list_scripts_machine_learning_ml_benchmark)
261. [i.MX RT1170 + NAFE13388 drivers and demos](#dm-nafe_rt1170)
262. [i.MX RT1170 Mirror and control android phone using Zephyr](#dm-i-mx-rt1170-android-phone-screen-mirroring)
263. [i.MX RT1180 based Holoscan Sensor Bridge (HSB)](#dm-rt1180-hsb)
264. [i.MX Smart Fitness](#nxp-demo-experience-demos-list_scripts_machine_learning_imx_smart_fitness)
265. [i.MX Smart Kitchen](#nxp-demo-experience-demos-list_scripts_multimedia_smart_kitchen)
266. [i.MX V4L2 Video Test Tool](#nxp-demo-experience-demos-list_scripts_multimedia_gstreamer_video_test)
267. [i.MX93 Low Power Machine Learning](#nxp-demo-experience-demos-list_scripts_machine_learning_low_power_ml)
268. [i.MX93 Smart Appliance for MATTER](#meta-smart-appliance)
269. [low power measurement on mcxn236](#dm-low-power-measurement-on-mcxn236)
270. [matter zigbee bridge rw612](#dm-matter-zigbee-bridge-rw612)
271. [vital signal monitor](#dm-mcxn947-lcd-heart-rate-spo2)
272. [wolfSSH RGB Server using Zephyr RTOS](#nxp-appcodehub_dm-wolfssh-rgb-server-with-zephyr)
273. [wolfSSL MQTT AWS Test using Zephyr RTOS](#nxp-appcodehub_dm-wolfmqtt-publisher-client-with-zephyr)
274. [wolfSSL TLSv1.3 Hello Server Doing Post-Quantum Cryptography using Zephyr RTOS](#nxp-appcodehub_dm-wolfssl-tls-hello-server-pqc-with-zephyr)
275. [wolfSSL TLSv1.3 Hello Server using Zephyr RTOS](#nxp-appcodehub_dm-wolftpm-wolfssl-tls-with-zephyr)
...
## 200. Secure Encrypted Ethernet End Nodes<a id="dm-secure-encrypt-eth-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 201. Selfie Segmenter<a id="nxp-demo-experience-demos-list_scripts_machine_learning_selfie_segmenter"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-uart-s32k344/. -->
## 202. Serial Communication Using FLEXIO and RTD<a id="dm-uart-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 203. Serial Terminal LED Control Using UART Driver<a id="dm-uart-button-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 204. Servo Steering Control Using PWM<a id="dm-pwm-steering-control-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 205. Simple HTTP Server with Remote Status Observation and Control<a id="dm-ethernet-server-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 206. Smart CAN Gateway for Automotive Actuators<a id="dm-smart-can-gtwy-frdm-a-s32k312-m276"></a> <a href="#top" style="float:right">⤒</a>
...
## 207. Smart Sensing Inhaler using Pressure and Tilt sensors<a id="dm-smart-sensing-inhaler"></a> <a href="#top" style="float:right">⤒</a>
...
## 208. Smart lighting LED bulb using LPC860<a id="dm-lpc860-smart-lighting"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- apps_zephyr/. -->
## 209. SmartWatch Zephyr Demo<a id="apps_zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 210. Snoring Detection based on RT1060 powered by AI\ML<a id="dm-snoring-detection-based-on-rt1060"></a> <a href="#top" style="float:right">⤒</a>
...
## 211. Startup Message via Serial Terminal Using UART Driver<a id="dm-uart-hello-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 212. Tamper detection with low-power wakeup sensor using BLE wireless UART<a id="dm-tamper-detection-using-low-power-wakeup-sensor-over-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 213. Temperature Acquisition and UART Reporting<a id="dm-adc-tempsense-uart-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 214. Temperature Sensing and Plotting on FreeMASTER<a id="dm-adc-tempsense-freemaster-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 215. Temperature monitor with Modbus and CAN running in zephyr<a id="dm-modbus-can-temp-monitor-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 216. Temperature sensor demo using FRDM-A-S32K344<a id="dm-temperature-monitor-lcd-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 217. Text to Speech with audio playback based on MIMXRT700<a id="dm-text-to-speech-based-on-rt700"></a> <a href="#top" style="float:right">⤒</a>
...
## 218. Thermostat Controller with Relay and UART Reporting<a id="dm-thermostat-relay-s32k118"></a> <a href="#top" style="float:right">⤒</a>
...
## 219. This demo provides APIs to configure and read accurate temperature using P3T1085UK sensor<a id="dm-p3t1085uk-temperature-sensor-driver-with-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 220. This example demonstrates FXLS89xxxF 3-axis accelerometer evaluation GUI using ISSDK and FreeMASTER<a id="dm-freemaster-fxls89xxxf-evaluation-gui-firmware"></a> <a href="#top" style="float:right">⤒</a>
...
## 221. Time Series Studio powered, on-device learning Fan anomaly detection based on FRDM-MCXA156<a id="dm-tss-powered-on-device-learning-fan-anomaly-based-on-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 222. Touch Keypad Tuning on MCXN<a id="dm-mcxn-touch-keypad-tuning"></a> <a href="#top" style="float:right">⤒</a>
...
## 223. Transmission Control Module On FRDM-A-S32K344<a id="dm-transmission-control-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-uart-s32k312/. -->
## 224. UART Communication Example using RTD Drivers on FRDM-A-S32K312<a id="dm-uart-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 225. UART Communication and LED Example on FRDM-A-S32K344<a id="dm-uart-button-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 226. UART Status Monitoring with Button Control<a id="dm-uart-button-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 227. UBX100 FreeMASTER evaluation GUI<a id="dm-ubx100-freemaster-gui"></a> <a href="#top" style="float:right">⤒</a>
...
## 228. UBX100 RF toolbox application<a id="dm-ubx100-rf-toolbox-application"></a> <a href="#top" style="float:right">⤒</a>
...
## 229. UBX100 flashloader demo application<a id="dm-ubx100-flashloader"></a> <a href="#top" style="float:right">⤒</a>
...
## 230. UWB Nearby Interaction with phones<a id="dm-uwb-nearby-interaction-with-phones"></a> <a href="#top" style="float:right">⤒</a>
...
## 231. UWB Presence Detection demo<a id="dm-uwb-presence-detection-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 232. Using EZH to implement camera interface in lpc55 series mcu<a id="dm-lpc55s69-camera-interface-by-ezh"></a> <a href="#top" style="float:right">⤒</a>
...
## 233. Using SmartDMA to implement camera interface in MCXN236<a id="dm-mcxn236-camera-interface-by-smartdma"></a> <a href="#top" style="float:right">⤒</a>
...
## 234. Vehicle Comfort Control for FRDM-A-S32K344<a id="dm-vehicle-comfort-control-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 235. Vehicle Lighting Control for Daylight and Hazard Signals<a id="dm-vehicle-lighting-signals-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 236. Vehicle Lighting Control for Daylight and Hazard Signals on FRDM-A-S32K312<a id="dm-vehicle-lighting-signals-frdm-a-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 237. Very simple serial bootloader for NXP MCU<a id="dm-nxp_mcu_easy_bootloader"></a> <a href="#top" style="float:right">⤒</a>
...
## 238. Visual Heart Rate Monitor<a id="dm-visual-heart-rate-monitor-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 239. Visualizing Sensor Data with FreeMASTER: Motion and Temperature<a id="dm-motion-temperature-freemaster-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 240. Vital Health Signal Visual Monitor On FRDM-A-S32K344<a id="dm-vital-health-signal-visual-monitor-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 241. Wake Up from Sleep Through Magnetic Detection<a id="dm-reed-low-power-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 242. Wake Up from Sleep via GPIO Button Press<a id="dm-gpio-button-wakeup-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 243. Weather Visual Monitor<a id="dm-weather-visual-monitor-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 244. Wi-Fi Easy Connect (DPP) In-Band Provisioning Demo on RT1060EVKC with IW612<a id="dm-dpp-in-band-provisioning-rt1060-iw612"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-wifi-set-up-ping/. -->
## 245. Wi-Fi Scan and Connectivity Demo on RW612BGA<a id="dm-wifi-set-up-ping"></a> <a href="#top" style="float:right">⤒</a>
...
## 246. Wi-Fi Sensing using Sniffer on RW61x with Zephyr OS<a id="dm-wifi-sensing-using-sniffer-on-rw61x-with-zephyr-os"></a> <a href="#top" style="float:right">⤒</a>
...
## 247. Wi-Fi connect using LCD interface on FRDM-MCXN947 using Wi-Fi expansion board FRDM-IW416-AW-AM510<a id="dm-wifi-lcd-connect-frdm-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 248. WiFi AP and BLE Peripheral on RDRW612BGA<a id="dm-wifi-ap-and-ble-peripheral-on-rdrw612bga"></a> <a href="#top" style="float:right">⤒</a>
...
## 249. WiFi CLI M2 FRDM MCXN947<a id="dm-wifi-cli-frdm-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 250. WiFi provisioning using BLE on RT1170 EVKB using Wi-Fi Module Murata 2EL<a id="dm-wifi-provisioning-using-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 251. Wireless Co-Processor Enabled Motor Control<a id="dm-mc-pmsm-ncp-frdm-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 252. Wireless RFTM Application for Performance Testing of RW612 board<a id="dm-wireless-rf-test-mode-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 253. Write a file to microSD Card<a id="dm-sd-card-write-file-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 254. [OOBE-MCXW71] Controlling LEDS using BLE Wireless UART<a id="dm-mcx-wireless-uart-leds"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-wifi-sta-mqtt/. -->
## 255. [RT1060 + IW416] MQTT client using Wi-Fi<a id="dm-wifi-sta-mqtt"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-afci-8ch-mcxn547/. -->
## 256. afci 8ch mcxn547 demo<a id="dm-afci-8ch-mcxn547"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-loc-apps-kw47/. -->
## 257. demo project to use the module sCan<a id="dm-loc-apps-kw47"></a> <a href="#top" style="float:right">⤒</a>
...
## 258. eIQ GenAI Flow Demonstrator<a id="dm-eiq-genai-flow-demonstrator"></a> <a href="#top" style="float:right">⤒</a>
...
## 259. i.MX Driver Monitor System<a id="nxp-demo-experience-demos-list_scripts_machine_learning_dms"></a> <a href="#top" style="float:right">⤒</a>
...
## 260. i.MX Machine Learning Benchmark Tool<a id="nxp-demo-experience-demos-list_scripts_machine_learning_ml_benchmark"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-nafe_rt1170/. -->
## 261. i.MX RT1170 + NAFE13388 drivers and demos<a id="dm-nafe_rt1170"></a> <a href="#top" style="float:right">⤒</a>
...
## 262. i.MX RT1170 Mirror and control android phone using Zephyr<a id="dm-i-mx-rt1170-android-phone-screen-mirroring"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-rt1180-hsb/. -->
## 263. i.MX RT1180 based Holoscan Sensor Bridge (HSB)<a id="dm-rt1180-hsb"></a> <a href="#top" style="float:right">⤒</a>
...
## 264. i.MX Smart Fitness<a id="nxp-demo-experience-demos-list_scripts_machine_learning_imx_smart_fitness"></a> <a href="#top" style="float:right">⤒</a>
...
## 265. i.MX Smart Kitchen<a id="nxp-demo-experience-demos-list_scripts_multimedia_smart_kitchen"></a> <a href="#top" style="float:right">⤒</a>
...
## 266. i.MX V4L2 Video Test Tool<a id="nxp-demo-experience-demos-list_scripts_multimedia_gstreamer_video_test"></a> <a href="#top" style="float:right">⤒</a>
...
## 267. i.MX93 Low Power Machine Learning<a id="nxp-demo-experience-demos-list_scripts_machine_learning_low_power_ml"></a> <a href="#top" style="float:right">⤒</a>
...
## 268. i.MX93 Smart Appliance for MATTER<a id="meta-smart-appliance"></a> <a href="#top" style="float:right">⤒</a>
...
## 269. low power measurement on mcxn236<a id="dm-low-power-measurement-on-mcxn236"></a> <a href="#top" style="float:right">⤒</a>
...
## 270. matter zigbee bridge rw612<a id="dm-matter-zigbee-bridge-rw612"></a> <a href="#top" style="float:right">⤒</a>
...
## 271. vital signal monitor<a id="dm-mcxn947-lcd-heart-rate-spo2"></a> <a href="#top" style="float:right">⤒</a>
...
## 272. wolfSSH RGB Server using Zephyr RTOS<a id="nxp-appcodehub_dm-wolfssh-rgb-server-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 273. wolfSSL MQTT AWS Test using Zephyr RTOS<a id="nxp-appcodehub_dm-wolfmqtt-publisher-client-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 274. wolfSSL TLSv1.3 Hello Server Doing Post-Quantum Cryptography using Zephyr RTOS<a id="nxp-appcodehub_dm-wolfssl-tls-hello-server-pqc-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 275. wolfSSL TLSv1.3 Hello Server using Zephyr RTOS<a id="nxp-appcodehub_dm-wolftpm-wolfssl-tls-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
