...
## Index
1. [BLE smart label based on LVGL using Waveshare e-ink display and KW45](#dm-lvgl-epaper-smartlabel-kw45_.)
2. [Instrument cluster demo on MIMXRT1170-EVK with Raspberry Pi 7" touch panel, using LVGL](#dm-lvgl_cluster_rt1170_evkb_rpi_.)
3. [Demo of coffee machine using voice recognition (VIT) and LVGL graphics on i.MX RT1060](#dm-lvgl-vit-rt1060_.)
4. [How to enable a LVGL cluster demo with i.MX RT1170-EVK.](#dm-lvgl_cluster_rt1170_evk_.)
5. [Leveraging deep learning to count the number of people in a room using a low-resolution 8x8 infrared array sensor](#dm-ml-ir-sensor-people-counting_.)
6. [LPC55S36 Low End Audio Demo](#dm-lpc55s36-low-end-audio-demo_.)
7. [LPC55S69 Multi Face Detection](#dm-lpc55s69-multi-face-detection_.)
8. [LPC55S69 Fashion Mnist Object Recognition](#dm-lpc55s69-fashion-mnist-object-recognition_.)
9. [Smart lighting LED bulb using LPC860](#dm-lpc860-smart-lighting_.)
10. [Full Appliance Demo](#dm-rt1170evkb-full-appliance_.)
11. [i.MX RT1170 + NAFE13388 drivers and demos](#dm-nafe_rt1170_.)
12. [Very simple serial bootloader for NXP MCU](#dm-nxp_mcu_easy_bootloader_.)
13. [Raw Video Playback Demo for MCX N947](#dm-mcxn947-video-playback_.)
14. [MCXN947 NPU vs Tensorflm Benchmark](#dm-mcxn947-npu-vs-tensorflm-benchmark_.)
15. [How to implement low power on MCXA153](#dm-low-power-implementation-mcxa153_.)
16. [Fashion MNIST Recognition on MCXN947](#dm-fashion-mnist-recognition-on-mcxn947_.)
17. [On device training fan anomaly detection on MCXN947](#dm-on-device-training-fan-anomaly-on-mcxn947_.)
18. [MCXN94x power manager training lab](#dm-mcxn947-power-manager_.)
19. [Label the CIFAR10 images from the camera on FRDM-MCXN947](#dm-label-cifar10-images-on-mcxn947_.)
20. [Heart rate (BPM) and SPO2 monitoring on FRDM-MCXA153](#dm-frdm-mcxa153-freemaster-heart-rate_.)
21. [How to implement USB audio 7.1 channel speaker on MCXN947](#dm-usb-audio-7-1-channel-speaker-on-mcxn947_.)
22. [Multiple face detection on mcxn947](#dm-multiple-face-detection-on-mcxn947_.)
23. [Multiple Person Detection on MCXN947](#dm-multiple-person-detection-on-mcxn947_.)
24. [How to develop an electric bicycle dashboard design on MCXN947](#dm-frdm-mcxn947-ebike_.)
25. [MCX STREAMDECK](#dm-mcx-streamdeck_.)
26. [Industrial Panel FRDM-MCXN947](#dm-industrial-panel-frdm-mcxn947_.)
27. [Magnetic Wake-up Example using NMH1000 Magnetic Switch Sensor](#dm-nmh1000-magnetic-switch-example_.)
28. [vital signal monitor](#dm-mcxn947-lcd-heart-rate-spo2_.)
29. [MCXN - how to enable the windowed watchdog on low power](#dm-mcxn-windowed-watchdog_.)
30. [Pressure and Altimeter Examples using MPL3115 Sensor](#dm-mpl3115-pressure-altimeter-examples_.)
31. [Using SmartDMA to implement camera interface in MCXN236](#dm-mcxn236-camera-interface-by-smartdma_.)
32. [This example demonstrates FXLS89xxxF 3-axis accelerometer evaluation GUI using ISSDK and FreeMASTER](#dm-freemaster-fxls89xxxf-evaluation-gui-firmware_.)
33. [This demo provides APIs to configure and read accurate temperature using P3T1085UK sensor](#dm-p3t1085uk-temperature-sensor-driver-with-demo-app_.)
34. [PCF2131 : Real Time Clock driver on FRDM-MCXN947.](#dm-pcf2131-real-time-clock-driver-with-demo-app_.)
35. [P3T1755: I3C temperature sensor demo](#dm-i3c-temperature-sensor_.)
36. [WiFi CLI M2 FRDM MCXN947](#dm-wifi-cli-frdm-mcxn947_.)
37. [K32W148 BLDC Motor control FreeRTOS application](#dm-bldc-motor-control-k32w148_.)
38. [Touch Keypad Tuning on MCXN](#dm-mcxn-touch-keypad-tuning_.)
39. [NMH1000 magnetic switch sensor evaluation GUI using ISSDK and FreeMASTER](#dm-freemaster-nmh1000-evaluation-gui-firmware_.)
40. [low power measurement on mcxn236](#dm-low-power-measurement-on-mcxn236_.)
41. [PCA9957HN led driver with demo app running on FRDM-MCXN947 and FRDM-MCXA153](#dm-pca9957hn-led-driver-with-demo-app_.)
42. [Multi sensor demo with FRDM-MCXN947 and LDC-PAR-S035](#dm-mcx-accel-and-pressure-monitor_.)
43. [Accel and Pressure sensor demo with FRDM-MCXA153](#dm-mcxa-accel-and-pressure-logger_.)
44. [RW612-FRDM Door chime demo with MQTT over Wi-Fi and I2S audio output](#dm-rw612frdm-door-chime-demo_.)
45. [[OOBE-MCXW71] Controlling LEDS using BLE Wireless UART](#dm-mcx-wireless-uart-leds_.)
46. [PCA9959HN led driver with demo app running on FRDM-MCXN947 and FRDM-MCXA153](#dm-pca9959hn-led-driver-with-demo-app_.)
47. [Nafe Industrial Application Examples using API Libraries](#dm-nafex388-application-examples_.)
48. [Implementation of Motor Control Algorithms to MCIMX93-EVK](#dm-motor-control-demo-for-i-mx93_.)
49. [EVSE-SIG-BRD using LPC5536/LPC55S36 for electric vehicle chargers](#dm-lpc5536-evse-sigbrd_.)
50. [PCF85063AT : Tiny Real Time Clock driver on FRDM-MCXN947 and MCXA153.](#dm-pcf85063at-real-time-clock-demo-app_.)
51. [A simple CAN bootloader project for FRDM-MCXA156](#dm-frdm-mcxa156-can-bootloader_.)
52. [Tamper detection with low-power wakeup sensor using BLE wireless UART](#dm-tamper-detection-using-low-power-wakeup-sensor-over-ble_.)
53. [wolfSSL MQTT AWS Test using Zephyr RTOS](#nxp-appcodehub_dm-wolfmqtt-publisher-client-with-zephyr)
54. [wolfSSH RGB Server using Zephyr RTOS](#nxp-appcodehub_dm-wolfssh-rgb-server-with-zephyr)
55. [wolfSSL TLSv1.3 Hello Server using Zephyr RTOS](#nxp-appcodehub_dm-wolftpm-wolfssl-tls-with-zephyr)
56. [FRDM RW612 Kitchen Timer](#dm-frdm-rw612-kitchen-timer_.)
57. [SmartWatch Zephyr Demo](#apps_zephyr_.)
58. [Facial Detection Zephyr Demo](#apps_zephyr_.)
59. [FRDMHB2002ESEVM: Driver and demo app for MC33HB2002ES H-bridge motor controller](#dm-frdmhb2002esevm-motor-control-demo-app_.)
60. [Integrating EdgeLock® SE05X to FRDM-MCX-N development boards](#nano-package_examples_se05x_crypto_mcxn947)
61. [SJA1124EVB : Quad LIN Commander Transceiver with LIN Commander Controller](#dm-sja1124evb-spi-to-quad-lin-bridge_.)
62. [FRDM33926PNBEVM: Driver and demo app for MC33926 motor controller](#dm-frdm33926pnbevm-motor-control-driver-demo-app_.)
63. [Driving LCD-PAR-S035 using LVGL on FRM-MCXW71 board](#dm-mcxw71-driving-lcd-wireless-uart_.)
64. [i.MX Driver Monitor System](#nxp-demo-experience-demos-list_scripts_machine_learning_dms)
65. [Portable Anomaly Detect Demo with FRDM-MCXN947 and FXLS8974CF (ML Vibro Sens Click)](#dm-mcxn-portable-anomaly-detect-demo_.)
66. [MCXW71 Accelerometer and light sensor over Wireless UART](#dm-mcxw71-accel-and-light-ble_.)
67. [NAFE13388-UIM Industrial Applications with GUI and CLI support .](#dm-nafe13388-application-examples_.)
68. [Smart Sensing Inhaler using Pressure and Tilt sensors](#dm-smart-sensing-inhaler_.)
69. [Precision Inclinometer (Bubble Level) with FXLS8971](#dm-mcxn-bubble-level-demo_.)
70. [Snoring Detection based on RT1060 powered by AI\ML](#dm-snoring-detection-based-on-rt1060_.)
71. [matter zigbee bridge rw612](#dm-matter-zigbee-bridge-rw612_.)
72. [Integrating EdgeLock® SE05X to FRDM-MCX-A development boards](#nano-package_examples_se05x_crypto_mcxa153)
73. [Demo of Mikroe Joystick2Click in FRDM with CMSIS driver and GPIO adapter](#dm-mikroe-joystick2click-frdm_.)
74. [Demo of mikroe oledBclick in FRDM with CMSIS driver and GPIO adapter](#dm-mikroe-oledbclick-frdm_.)
75. [Demo of Mikroe Relay5CLick in FRDM with CMSIS driver and GPIO adapter](#dm-mikroe-relay5click-frdm_.)
76. [PMIC for Low Power Applications on FRDM-MCXN947 and MCXA153](#dm-pca9420uk-evm-pmic-for-low-power-application_.)
77. [Time Series Studio powered, on-device learning Fan anomaly detection based on FRDM-MCXA156](#dm-tss-powered-on-device-learning-fan-anomaly-based-on-mcxa156_.)
78. [MCXC444 LCD display and FXLS8974CF accelerometer motion detection](#dm-mcxc444-lcd-and-fxls8974cf-motion-detection_.)
79. [Wi-Fi connect using LCD interface on FRDM-MCXN947 using Wi-Fi expansion board FRDM-IW416-AW-AM510](#dm-wifi-lcd-connect-frdm-mcxn947_.)
80. [4x4 Key Click: multi-platform ecosystem.](#dm-mikroe-4x4-key-click-frdm_.)
81. [Knob G Click: multi-platform ecosystem.](#dm-mikroe-knob-g-click-frdm_.)
82. [FRDM-MCXN947 Sensorless Anomaly Detection for Motor Control System](#dm-ml-sensorless-anomaly-detection_.)
83. [i.MX Driver Monitor System](#nxp-demo-experience-demos-list_scripts_machine_learning_dms)
84. [i.MX Smart Fitness](#nxp-demo-experience-demos-list_scripts_machine_learning_imx_smart_fitness)
85. [i.MX Machine Learning Benchmark Tool](#nxp-demo-experience-demos-list_scripts_machine_learning_ml_benchmark)
...
88. [Selfie Segmenter](#nxp-demo-experience-demos-list_scripts_machine_learning_selfie_segmenter)
89. [i.MX V4L2 Video Test Tool](#nxp-demo-experience-demos-list_scripts_multimedia_gstreamer_video_test)
90. [i.MX Smart Kitchen](#nxp-demo-experience-demos-list_scripts_multimedia_smart_kitchen)
91. [Clea Edgehog IoT devices using Zephyr RTOS](#edgehog-zephyr-device_samples_edgehog_app)
92. [Clea Astarte IoT devices using Zephyr RTOS](#astarte-device-sdk-zephyr_samples_astarte_app)
93. [KNX IoT stack examples running on FRDM-MCXW71](#dm-knx-iot-examples-on-nxp-mcxw71_.)
94. [PCA9422: PCA9422 Ultra Low Power Charger and Gauge PMIC for RT5/6/700 demo application on FRDM-MCXN947 and MCXA153 ](#dm-pca9422-evb-ultra-low-power-charger-gauge-pmic-demo-app_.)
95. [PCA9846: Four-Channel Ultra-Low Voltage, Fm+ I2C-Bus Switch with Reset demo application ](#dm-pca9846pw-ard-ultra-low-voltage-fm-plus-i2c-bus-switch-demo-app_.)
96. [PCAL6416AEV-ARD Low-Voltage Translating 16-Bit I²C-Bus/SMBus I/O Expander](#dm-pcal6416aev-low-voltage-translating-16-bit-i2c-bus-smbus-io-expander_.)
97. [NAFE13388 Universal Analog Sensing Module with Wired Connectivity](#dm-mcxn947-remote-io-with-nafe13388_.)
98. [Integrating EdgeLock® A30 secure authenticator to FRDM-MCXA153 board](#dm-a30-mcxa153-ecc-example_.)
99. [KW45: Secure boot scripts based on spsdk](#dm-kw45-secure-boot-scripts_.)
100. [Motor RPM Grapher in OLED with USB](#dm-ip-frdmmcxa153-oled-motor-graph-usb_.)
101. [P3H2X4X : I3C hub demo application on FRDM MCXN947 and MCXA153](#dm-p3h2x4x-i3c-hub-demo-application_.)
102. [FRDM-RW612 GUI Guider integration on Bluetooth LE example](#dm-nxp-rw612-gui-guider-ble_.)
103. [Motor RPM Control with KnobGClick and RPM Display in Real Time with USB](#dm-ip-frdmmcxc444-rotary-motor-update-usb_.)
104. [Motor RPM Control with KnobGClick with USB](#dm-ip-frdmmcxc242-rotary-motor-update-usb_.)
105. [eIQ GenAI Flow Demonstrator](#dm-eiq-genai-flow-demonstrator_.)
106. [Door Lock Cluster integration on a Lighting App Matter Application using K32W061 DK6](#dm-nxp-k32w061-dk6-door-lock-and-lighting-app-matter-application_.)
107. [PCAL9722: 22-Bit SPI I/O Expander with Agile I/O Features](#dm-pcal9722hn-22-bit-spi-gpio-expander_.)
108. [i.MX93 Smart Appliance for MATTER](#meta-smart-appliance_.)
109. [24-Channel SPI Serial Bus 63 mA / 5.5 V Constant-Current LED Driver](#dm-pca9958hn-led-driver-with-spi-demo-app_.)
110. [NXP Platform Accelerator for RW612 Freedom](#npa-vee-rw612_.)
111. [NXP Platform Accelerator for MCXN947 Freedom Board](#nxp-vee-mcxn947-frdm_.)
112. [NXP Platform Accelerator for i.MXRT595 EVK](#nxp-vee-imxrt595-evk_.)
113. [NXP Platform Accelerator for i.MXRT1170 EVK](#nxp-vee-imxrt1170-evk_.)
114. [HTTPS LCD LED Demo](#dm-https-lcd-led-demo_.)
115. [Wi-Fi Scan and Connectivity Demo on RW612BGA](#dm-wifi-set-up-ping_.)
116. [DeepPacket: Encrypted network packets classification system](#app-network-ml_.)
117. [Low-Voltage Translating, 8-Bit I²C-Bus/SMBus I/O Expander](#dm-pcal6408a-8-bit-i2c-gpio-expander_.)
118. [Matter EdgeLock 2GO secure lock example running on RW612](#dm-matter-secure-lock-on-rw612_.)

<!-- dm-lvgl-epaper-smartlabel-kw45/. -->
## 1. BLE smart label based on LVGL using Waveshare e-ink display and KW45<a id="dm-lvgl-epaper-smartlabel-kw45_."></a> <a href="#top" style="float:right">⤒</a>
...
## 2. Instrument cluster demo on MIMXRT1170-EVK with Raspberry Pi 7" touch panel, using LVGL<a id="dm-lvgl_cluster_rt1170_evkb_rpi_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-lvgl-vit-rt1060/. -->
## 3. Demo of coffee machine using voice recognition (VIT) and LVGL graphics on i.MX RT1060<a id="dm-lvgl-vit-rt1060_."></a> <a href="#top" style="float:right">⤒</a>
...
## 4. How to enable a LVGL cluster demo with i.MX RT1170-EVK.<a id="dm-lvgl_cluster_rt1170_evk_."></a> <a href="#top" style="float:right">⤒</a>
...
## 5. Leveraging deep learning to count the number of people in a room using a low-resolution 8x8 infrared array sensor<a id="dm-ml-ir-sensor-people-counting_."></a> <a href="#top" style="float:right">⤒</a>
...
## 6. LPC55S36 Low End Audio Demo<a id="dm-lpc55s36-low-end-audio-demo_."></a> <a href="#top" style="float:right">⤒</a>
...
## 7. LPC55S69 Multi Face Detection<a id="dm-lpc55s69-multi-face-detection_."></a> <a href="#top" style="float:right">⤒</a>
...
## 8. LPC55S69 Fashion Mnist Object Recognition<a id="dm-lpc55s69-fashion-mnist-object-recognition_."></a> <a href="#top" style="float:right">⤒</a>
...
## 9. Smart lighting LED bulb using LPC860<a id="dm-lpc860-smart-lighting_."></a> <a href="#top" style="float:right">⤒</a>
...
## 10. Full Appliance Demo<a id="dm-rt1170evkb-full-appliance_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-nafe_rt1170/. -->
## 11. i.MX RT1170 + NAFE13388 drivers and demos<a id="dm-nafe_rt1170_."></a> <a href="#top" style="float:right">⤒</a>
...
## 12. Very simple serial bootloader for NXP MCU<a id="dm-nxp_mcu_easy_bootloader_."></a> <a href="#top" style="float:right">⤒</a>
...
## 13. Raw Video Playback Demo for MCX N947<a id="dm-mcxn947-video-playback_."></a> <a href="#top" style="float:right">⤒</a>
...
## 14. MCXN947 NPU vs Tensorflm Benchmark<a id="dm-mcxn947-npu-vs-tensorflm-benchmark_."></a> <a href="#top" style="float:right">⤒</a>
...
## 15. How to implement low power on MCXA153<a id="dm-low-power-implementation-mcxa153_."></a> <a href="#top" style="float:right">⤒</a>
...
## 16. Fashion MNIST Recognition on MCXN947<a id="dm-fashion-mnist-recognition-on-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 17. On device training fan anomaly detection on MCXN947<a id="dm-on-device-training-fan-anomaly-on-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 18. MCXN94x power manager training lab<a id="dm-mcxn947-power-manager_."></a> <a href="#top" style="float:right">⤒</a>
...
## 19. Label the CIFAR10 images from the camera on FRDM-MCXN947<a id="dm-label-cifar10-images-on-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 20. Heart rate (BPM) and SPO2 monitoring on FRDM-MCXA153<a id="dm-frdm-mcxa153-freemaster-heart-rate_."></a> <a href="#top" style="float:right">⤒</a>
...
## 21. How to implement USB audio 7.1 channel speaker on MCXN947<a id="dm-usb-audio-7-1-channel-speaker-on-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 22. Multiple face detection on mcxn947<a id="dm-multiple-face-detection-on-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 23. Multiple Person Detection on MCXN947<a id="dm-multiple-person-detection-on-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 24. How to develop an electric bicycle dashboard design on MCXN947<a id="dm-frdm-mcxn947-ebike_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-mcx-streamdeck/. -->
## 25. MCX STREAMDECK<a id="dm-mcx-streamdeck_."></a> <a href="#top" style="float:right">⤒</a>
...
## 26. Industrial Panel FRDM-MCXN947<a id="dm-industrial-panel-frdm-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 27. Magnetic Wake-up Example using NMH1000 Magnetic Switch Sensor<a id="dm-nmh1000-magnetic-switch-example_."></a> <a href="#top" style="float:right">⤒</a>
...
## 28. vital signal monitor<a id="dm-mcxn947-lcd-heart-rate-spo2_."></a> <a href="#top" style="float:right">⤒</a>
...
## 29. MCXN - how to enable the windowed watchdog on low power<a id="dm-mcxn-windowed-watchdog_."></a> <a href="#top" style="float:right">⤒</a>
...
## 30. Pressure and Altimeter Examples using MPL3115 Sensor<a id="dm-mpl3115-pressure-altimeter-examples_."></a> <a href="#top" style="float:right">⤒</a>
...
## 31. Using SmartDMA to implement camera interface in MCXN236<a id="dm-mcxn236-camera-interface-by-smartdma_."></a> <a href="#top" style="float:right">⤒</a>
...
## 32. This example demonstrates FXLS89xxxF 3-axis accelerometer evaluation GUI using ISSDK and FreeMASTER<a id="dm-freemaster-fxls89xxxf-evaluation-gui-firmware_."></a> <a href="#top" style="float:right">⤒</a>
...
## 33. This demo provides APIs to configure and read accurate temperature using P3T1085UK sensor<a id="dm-p3t1085uk-temperature-sensor-driver-with-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 34. PCF2131 : Real Time Clock driver on FRDM-MCXN947.<a id="dm-pcf2131-real-time-clock-driver-with-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 35. P3T1755: I3C temperature sensor demo<a id="dm-i3c-temperature-sensor_."></a> <a href="#top" style="float:right">⤒</a>
...
## 36. WiFi CLI M2 FRDM MCXN947<a id="dm-wifi-cli-frdm-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 37. K32W148 BLDC Motor control FreeRTOS application<a id="dm-bldc-motor-control-k32w148_."></a> <a href="#top" style="float:right">⤒</a>
...
## 38. Touch Keypad Tuning on MCXN<a id="dm-mcxn-touch-keypad-tuning_."></a> <a href="#top" style="float:right">⤒</a>
...
## 39. NMH1000 magnetic switch sensor evaluation GUI using ISSDK and FreeMASTER<a id="dm-freemaster-nmh1000-evaluation-gui-firmware_."></a> <a href="#top" style="float:right">⤒</a>
...
## 40. low power measurement on mcxn236<a id="dm-low-power-measurement-on-mcxn236_."></a> <a href="#top" style="float:right">⤒</a>
...
## 41. PCA9957HN led driver with demo app running on FRDM-MCXN947 and FRDM-MCXA153<a id="dm-pca9957hn-led-driver-with-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 42. Multi sensor demo with FRDM-MCXN947 and LDC-PAR-S035<a id="dm-mcx-accel-and-pressure-monitor_."></a> <a href="#top" style="float:right">⤒</a>
...
## 43. Accel and Pressure sensor demo with FRDM-MCXA153<a id="dm-mcxa-accel-and-pressure-logger_."></a> <a href="#top" style="float:right">⤒</a>
...
## 44. RW612-FRDM Door chime demo with MQTT over Wi-Fi and I2S audio output<a id="dm-rw612frdm-door-chime-demo_."></a> <a href="#top" style="float:right">⤒</a>
...
## 45. [OOBE-MCXW71] Controlling LEDS using BLE Wireless UART<a id="dm-mcx-wireless-uart-leds_."></a> <a href="#top" style="float:right">⤒</a>
...
## 46. PCA9959HN led driver with demo app running on FRDM-MCXN947 and FRDM-MCXA153<a id="dm-pca9959hn-led-driver-with-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 47. Nafe Industrial Application Examples using API Libraries<a id="dm-nafex388-application-examples_."></a> <a href="#top" style="float:right">⤒</a>
...
## 48. Implementation of Motor Control Algorithms to MCIMX93-EVK<a id="dm-motor-control-demo-for-i-mx93_."></a> <a href="#top" style="float:right">⤒</a>
...
## 49. EVSE-SIG-BRD using LPC5536/LPC55S36 for electric vehicle chargers<a id="dm-lpc5536-evse-sigbrd_."></a> <a href="#top" style="float:right">⤒</a>
...
## 50. PCF85063AT : Tiny Real Time Clock driver on FRDM-MCXN947 and MCXA153.<a id="dm-pcf85063at-real-time-clock-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 51. A simple CAN bootloader project for FRDM-MCXA156<a id="dm-frdm-mcxa156-can-bootloader_."></a> <a href="#top" style="float:right">⤒</a>
...
## 52. Tamper detection with low-power wakeup sensor using BLE wireless UART<a id="dm-tamper-detection-using-low-power-wakeup-sensor-over-ble_."></a> <a href="#top" style="float:right">⤒</a>
...
## 53. wolfSSL MQTT AWS Test using Zephyr RTOS<a id="nxp-appcodehub_dm-wolfmqtt-publisher-client-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 54. wolfSSH RGB Server using Zephyr RTOS<a id="nxp-appcodehub_dm-wolfssh-rgb-server-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 55. wolfSSL TLSv1.3 Hello Server using Zephyr RTOS<a id="nxp-appcodehub_dm-wolftpm-wolfssl-tls-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 56. FRDM RW612 Kitchen Timer<a id="dm-frdm-rw612-kitchen-timer_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- apps_zephyr/. -->
## 57. SmartWatch Zephyr Demo<a id="apps_zephyr_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- apps_zephyr/. -->
## 58. Facial Detection Zephyr Demo<a id="apps_zephyr_."></a> <a href="#top" style="float:right">⤒</a>
...
## 59. FRDMHB2002ESEVM: Driver and demo app for MC33HB2002ES H-bridge motor controller<a id="dm-frdmhb2002esevm-motor-control-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 61. SJA1124EVB : Quad LIN Commander Transceiver with LIN Commander Controller<a id="dm-sja1124evb-spi-to-quad-lin-bridge_."></a> <a href="#top" style="float:right">⤒</a>
...
## 62. FRDM33926PNBEVM: Driver and demo app for MC33926 motor controller<a id="dm-frdm33926pnbevm-motor-control-driver-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 63. Driving LCD-PAR-S035 using LVGL on FRM-MCXW71 board<a id="dm-mcxw71-driving-lcd-wireless-uart_."></a> <a href="#top" style="float:right">⤒</a>
...
## 64. i.MX Driver Monitor System<a id="nxp-demo-experience-demos-list_scripts_machine_learning_dms"></a> <a href="#top" style="float:right">⤒</a>
...
## 65. Portable Anomaly Detect Demo with FRDM-MCXN947 and FXLS8974CF (ML Vibro Sens Click)<a id="dm-mcxn-portable-anomaly-detect-demo_."></a> <a href="#top" style="float:right">⤒</a>
...
## 66. MCXW71 Accelerometer and light sensor over Wireless UART<a id="dm-mcxw71-accel-and-light-ble_."></a> <a href="#top" style="float:right">⤒</a>
...
## 67. NAFE13388-UIM Industrial Applications with GUI and CLI support .<a id="dm-nafe13388-application-examples_."></a> <a href="#top" style="float:right">⤒</a>
...
## 68. Smart Sensing Inhaler using Pressure and Tilt sensors<a id="dm-smart-sensing-inhaler_."></a> <a href="#top" style="float:right">⤒</a>
...
## 69. Precision Inclinometer (Bubble Level) with FXLS8971<a id="dm-mcxn-bubble-level-demo_."></a> <a href="#top" style="float:right">⤒</a>
...
## 70. Snoring Detection based on RT1060 powered by AI\ML<a id="dm-snoring-detection-based-on-rt1060_."></a> <a href="#top" style="float:right">⤒</a>
...
## 71. matter zigbee bridge rw612<a id="dm-matter-zigbee-bridge-rw612_."></a> <a href="#top" style="float:right">⤒</a>
...
## 73. Demo of Mikroe Joystick2Click in FRDM with CMSIS driver and GPIO adapter<a id="dm-mikroe-joystick2click-frdm_."></a> <a href="#top" style="float:right">⤒</a>
...
## 74. Demo of mikroe oledBclick in FRDM with CMSIS driver and GPIO adapter<a id="dm-mikroe-oledbclick-frdm_."></a> <a href="#top" style="float:right">⤒</a>
...
## 75. Demo of Mikroe Relay5CLick in FRDM with CMSIS driver and GPIO adapter<a id="dm-mikroe-relay5click-frdm_."></a> <a href="#top" style="float:right">⤒</a>
...
## 76. PMIC for Low Power Applications on FRDM-MCXN947 and MCXA153<a id="dm-pca9420uk-evm-pmic-for-low-power-application_."></a> <a href="#top" style="float:right">⤒</a>
...
## 77. Time Series Studio powered, on-device learning Fan anomaly detection based on FRDM-MCXA156<a id="dm-tss-powered-on-device-learning-fan-anomaly-based-on-mcxa156_."></a> <a href="#top" style="float:right">⤒</a>
...
## 78. MCXC444 LCD display and FXLS8974CF accelerometer motion detection<a id="dm-mcxc444-lcd-and-fxls8974cf-motion-detection_."></a> <a href="#top" style="float:right">⤒</a>
...
## 79. Wi-Fi connect using LCD interface on FRDM-MCXN947 using Wi-Fi expansion board FRDM-IW416-AW-AM510<a id="dm-wifi-lcd-connect-frdm-mcxn947_."></a> <a href="#top" style="float:right">⤒</a>
...
## 80. 4x4 Key Click: multi-platform ecosystem.<a id="dm-mikroe-4x4-key-click-frdm_."></a> <a href="#top" style="float:right">⤒</a>
...
## 81. Knob G Click: multi-platform ecosystem.<a id="dm-mikroe-knob-g-click-frdm_."></a> <a href="#top" style="float:right">⤒</a>
...
## 82. FRDM-MCXN947 Sensorless Anomaly Detection for Motor Control System<a id="dm-ml-sensorless-anomaly-detection_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- nxp-demo-experience-demos-list/scripts/machine_learning/dms -->
## 83. i.MX Driver Monitor System<a id="nxp-demo-experience-demos-list_scripts_machine_learning_dms"></a> <a href="#top" style="float:right">⤒</a>
...
## 84. i.MX Smart Fitness<a id="nxp-demo-experience-demos-list_scripts_machine_learning_imx_smart_fitness"></a> <a href="#top" style="float:right">⤒</a>
...
## 85. i.MX Machine Learning Benchmark Tool<a id="nxp-demo-experience-demos-list_scripts_machine_learning_ml_benchmark"></a> <a href="#top" style="float:right">⤒</a>
...
## 88. Selfie Segmenter<a id="nxp-demo-experience-demos-list_scripts_machine_learning_selfie_segmenter"></a> <a href="#top" style="float:right">⤒</a>
...
## 89. i.MX V4L2 Video Test Tool<a id="nxp-demo-experience-demos-list_scripts_multimedia_gstreamer_video_test"></a> <a href="#top" style="float:right">⤒</a>
...
## 90. i.MX Smart Kitchen<a id="nxp-demo-experience-demos-list_scripts_multimedia_smart_kitchen"></a> <a href="#top" style="float:right">⤒</a>
...
## 91. Clea Edgehog IoT devices using Zephyr RTOS<a id="edgehog-zephyr-device_samples_edgehog_app"></a> <a href="#top" style="float:right">⤒</a>
...
## 92. Clea Astarte IoT devices using Zephyr RTOS<a id="astarte-device-sdk-zephyr_samples_astarte_app"></a> <a href="#top" style="float:right">⤒</a>
...
## 93. KNX IoT stack examples running on FRDM-MCXW71<a id="dm-knx-iot-examples-on-nxp-mcxw71_."></a> <a href="#top" style="float:right">⤒</a>
...
## 94. PCA9422: PCA9422 Ultra Low Power Charger and Gauge PMIC for RT5/6/700 demo application on FRDM-MCXN947 and MCXA153 <a id="dm-pca9422-evb-ultra-low-power-charger-gauge-pmic-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 95. PCA9846: Four-Channel Ultra-Low Voltage, Fm+ I2C-Bus Switch with Reset demo application <a id="dm-pca9846pw-ard-ultra-low-voltage-fm-plus-i2c-bus-switch-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
## 96. PCAL6416AEV-ARD Low-Voltage Translating 16-Bit I²C-Bus/SMBus I/O Expander<a id="dm-pcal6416aev-low-voltage-translating-16-bit-i2c-bus-smbus-io-expander_."></a> <a href="#top" style="float:right">⤒</a>
...
## 97. NAFE13388 Universal Analog Sensing Module with Wired Connectivity<a id="dm-mcxn947-remote-io-with-nafe13388_."></a> <a href="#top" style="float:right">⤒</a>
...
## 98. Integrating EdgeLock® A30 secure authenticator to FRDM-MCXA153 board<a id="dm-a30-mcxa153-ecc-example_."></a> <a href="#top" style="float:right">⤒</a>
...
## 99. KW45: Secure boot scripts based on spsdk<a id="dm-kw45-secure-boot-scripts_."></a> <a href="#top" style="float:right">⤒</a>
...
## 100. Motor RPM Grapher in OLED with USB<a id="dm-ip-frdmmcxa153-oled-motor-graph-usb_."></a> <a href="#top" style="float:right">⤒</a>
...
## 101. P3H2X4X : I3C hub demo application on FRDM MCXN947 and MCXA153<a id="dm-p3h2x4x-i3c-hub-demo-application_."></a> <a href="#top" style="float:right">⤒</a>
...
## 102. FRDM-RW612 GUI Guider integration on Bluetooth LE example<a id="dm-nxp-rw612-gui-guider-ble_."></a> <a href="#top" style="float:right">⤒</a>
...
## 103. Motor RPM Control with KnobGClick and RPM Display in Real Time with USB<a id="dm-ip-frdmmcxc444-rotary-motor-update-usb_."></a> <a href="#top" style="float:right">⤒</a>
...
## 104. Motor RPM Control with KnobGClick with USB<a id="dm-ip-frdmmcxc242-rotary-motor-update-usb_."></a> <a href="#top" style="float:right">⤒</a>
...
## 105. eIQ GenAI Flow Demonstrator<a id="dm-eiq-genai-flow-demonstrator_."></a> <a href="#top" style="float:right">⤒</a>
...
## 106. Door Lock Cluster integration on a Lighting App Matter Application using K32W061 DK6<a id="dm-nxp-k32w061-dk6-door-lock-and-lighting-app-matter-application_."></a> <a href="#top" style="float:right">⤒</a>
...
## 107. PCAL9722: 22-Bit SPI I/O Expander with Agile I/O Features<a id="dm-pcal9722hn-22-bit-spi-gpio-expander_."></a> <a href="#top" style="float:right">⤒</a>
...
## 108. i.MX93 Smart Appliance for MATTER<a id="meta-smart-appliance_."></a> <a href="#top" style="float:right">⤒</a>
...
## 109. 24-Channel SPI Serial Bus 63 mA / 5.5 V Constant-Current LED Driver<a id="dm-pca9958hn-led-driver-with-spi-demo-app_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- npa-vee-rw612/. -->
## 110. NXP Platform Accelerator for RW612 Freedom<a id="npa-vee-rw612_."></a> <a href="#top" style="float:right">⤒</a>
...
## 111. NXP Platform Accelerator for MCXN947 Freedom Board<a id="nxp-vee-mcxn947-frdm_."></a> <a href="#top" style="float:right">⤒</a>
...
## 112. NXP Platform Accelerator for i.MXRT595 EVK<a id="nxp-vee-imxrt595-evk_."></a> <a href="#top" style="float:right">⤒</a>
...
## 113. NXP Platform Accelerator for i.MXRT1170 EVK<a id="nxp-vee-imxrt1170-evk_."></a> <a href="#top" style="float:right">⤒</a>
...
## 114. HTTPS LCD LED Demo<a id="dm-https-lcd-led-demo_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-wifi-set-up-ping/. -->
## 115. Wi-Fi Scan and Connectivity Demo on RW612BGA<a id="dm-wifi-set-up-ping_."></a> <a href="#top" style="float:right">⤒</a>
...
<!-- app-network-ml/. -->
## 116. DeepPacket: Encrypted network packets classification system<a id="app-network-ml_."></a> <a href="#top" style="float:right">⤒</a>
...
## 117. Low-Voltage Translating, 8-Bit I²C-Bus/SMBus I/O Expander<a id="dm-pcal6408a-8-bit-i2c-gpio-expander_."></a> <a href="#top" style="float:right">⤒</a>
...
## 118. Matter EdgeLock 2GO secure lock example running on RW612<a id="dm-matter-secure-lock-on-rw612_."></a> <a href="#top" style="float:right">⤒</a>
