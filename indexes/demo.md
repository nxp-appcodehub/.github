...
15. [BLE smart label based on LVGL using Waveshare e-ink display and KW45](#dm-lvgl-epaper-smartlabel-kw45)
16. [BLE throughput measurement on RT1170 EVKB + IW612](#dm-ble-throughput-measurement-rt1170)
17. [Bluetooth LE FSCI Host Application running on FRDM-MCXN947 and MCXW236B-EXP Board](#dm-ble-fsci-host-application)
18. [Bluetooth® Channel Sounding](#dm-frdm-mcxw72-channel-sounding-with-oled-b-click)
19. [Button Press to Wake-Up from Standby and send UART messages](#dm-gpio-button-wakeup-s32k312)
20. [Clea Astarte IoT devices using Zephyr RTOS](#astarte-device-sdk-zephyr_samples_astarte_app)
21. [Clea Edgehog IoT devices using Zephyr RTOS](#edgehog-zephyr-device_samples_edgehog_app)
22. [Control LED Brightness with eMIOS PWM using ADC and UART messaging](#dm-control-led-emios-pwm-adc-uart-s32k358)
23. [Control LED brightness through eMIOS PWM function on FRDM-A-S32K344 using MCAL drivers](#dm-control-led-emios-pwm-s32k344-mcal)
24. [Control LED brightness through eMIOS PWM using MCAL drivers with UART](#dm-control-led-emios-pwm-s32k312-mcal)
25. [Control WS2812 LED intensity with ADC Potentiometer](#dm-adc-pot-led-ws2812-intensity-s32k312)
26. [Controlling LEDs with GPIO](#dm-gpio-blinky-s32k312)
27. [Controlling WS2812 LED Brightness with an Analog Potentiometer](#dm-adc-pot-led-ws2812-intensity-s32k358)
28. [DeepPacket: Encrypted network packets classification system](#app-network-ml)
29. [Demo and steps creating new Zephyr app repo and custom board](#dm-create-zephyr-app-repo)
30. [Demo for Mikroe Joystick2Click in FRDM with CMSIS driver and GPIO adapter](#dm-mikroe-joystick2click-frdm)
31. [Demo of MikroE Oled C Click display in FRDM-MCX with CMSIS driver and GPIO adapter](#dm-mikroe-oled-c-click-display-frdm)
32. [Demo of Mikroe OledBClick in FRDM with CMSIS driver and GPIO adapter](#dm-mikroe-oledbclick-frdm)
33. [Demo of Mikroe Relay5CLick in FRDM with CMSIS driver and GPIO adapter](#dm-mikroe-relay5click-frdm)
34. [Demo of coffee machine using voice recognition (VIT) and LVGL graphics on i.MX RT1060](#dm-lvgl-vit-rt1060)
35. [Door Lock Cluster integration on a Lighting App Matter Application using K32W061 DK6](#dm-nxp-k32w061-dk6-door-lock-and-lighting-app-matter-application)
36. [Driving LCD-PAR-S035 using LVGL on FRM-MCXW71 board](#dm-mcxw71-driving-lcd-wireless-uart)
37. [EVSE-SIG-BRD using LPC5536/LPC55S36 for electric vehicle chargers](#dm-lpc5536-evse-sigbrd)
38. [EZH implements Quad encoder function in lpc5516](#dm-lpc55s16-qei-interface-by-ezh)
39. [EZH implements keyscan function in lpc5516](#dm-lpc55s16-keyscan-by-ezh)
40. [Edge AI Vision on Zephyr](#apps_zephyr)
41. [Emergency LED-Based Brake Status Monitoring on FRDM-A-S32K312](#dm-brake-control-s32k312)
42. [Ethernet Communication using FRDM-A-S32K344](#dm-high-speed-eth-frdm-a-s32k344)
43. [Ethernet Frame CRC Validator over UDP](#dm-ethernet-crc-s32k344)
44. [FRDM MCXW72 802.15.4 MAC application with wireless UART support](#dm-frdmmcxw72-wireless-uart-15-4-mac-app)
45. [FRDM RW612 Kitchen Timer](#dm-frdm-rw612-kitchen-timer)
46. [FRDM-MCXA266 Driving 6 Color ePaper Display with GDEB0709E01 Using LPSPI Quad Mode](#dm-mcxa266-6color-epaper-display-using-lpspi-quad-mode)
47. [FRDM-MCXC162 RGB Rainbow Wheel using CTIMER PWM](#dm-frdmmcxc162-rgb-pwm-rainbow-wheel)
48. [FRDM-MCXC242 Plug-and-Play NFC Controller Enablement with PN7160](#dm-mcxc242-pn7160-plug-and-play-nfc-controller)
49. [FRDM-MCXN947 Sensorless Anomaly Detection for Motor Control System](#dm-ml-sensorless-anomaly-detection)
50. [FRDM-MCXW72 Bluetooth Mesh sensor network on zephyr](#dm-frdmmcxw72-bluetooth-mesh-sensor-network-on-zephyr)
51. [FRDM-MCXW72 LCD-PAR-S035 enablement and control over PMOD](#dm-mcxw72-lcd-enablement-over-pmod)
52. [FRDM-MCXW72 Servo motor control using internal TPM or external PCA9685 controller](#dm-frdmmcxw72-servo-motor-multi-control)
53. [FRDM-MCXW72 Servo motor control using internal TPM or external PCA9685 controller and remote wireless UART commands and LCD GUI](#dm-frdmmcxw72-servo-motor-multi-control-with-wireless-uart-and-lcd)
54. [FRDM-MCXW72 Servo motor multi control with wireless UART on Zephyr](#dm-frdmmcxw72-servo-motor-multi-control-with-wireless-uart-on-zephyr)
55. [FRDM-RW612 GUI Guider integration on Bluetooth LE example](#dm-nxp-rw612-gui-guider-ble)
56. [FRDM-RW612 Heart Rate sensor over BLE](#dm-frdmrw612-heart-rate-sensor-over-ble)
57. [FRDM-RW612 Matter standalone temperature measurement with on-board sensor](#dm-frdm-rw612-matter-standalone-temperature-sensor)
58. [FRDM-RW612 On-board temperature sensor over BLE](#dm-frdmrw612-temperature-sensor-over-ble)
59. [FRDM-RW612 Smart Aircon with Wi-Fi and MQTT](#dm-frdm-rw612-smart-aircon-with-wifi-and-mqtt)
60. [FRDM-RW612 Voice Intelligent Technology on Zephyr RTOS](#dm-frdm-rw612-vit-on-zephyr)
61. [FRDM-RW612 external accelerometer sensor over BLE](#dm-frdmrw612-accelerometer-sensor-over-ble)
62. [FRDM33926PNBEVM: Driver and demo app for MC33926 motor controller](#dm-frdm33926pnbevm-motor-control-driver-demo-app)
...
64. [FRDM‑RW612 Wi‑Fi Access Point to Ethernet Layer‑2 Bridging Demonstration](#dm-rw612-wi-fi-ethernet-bridge)
65. [Fashion MNIST Recognition on MCXN947](#dm-fashion-mnist-recognition-on-mcxn947)
66. [FreeRTOS-Based LittleFS Support on SPI-NAND (W25N01GV) for FRDM-RW612](#dm-nand-flash-support-on-frdmrw612)
67. [Full Appliance Demo](#dm-rt1170evkb-full-appliance)
68. [GPIO Blinking LED Demo for FRDM-A-S32K344](#dm-gpio-blinky-s32k344)
69. [GPIO-Based Wake-Up from Standby Mode on S32K356](#dm-gpio-button-wakeup-s32k356)
70. [Getting Started with Multicore LED Control on FRDM-A-S32K356](#dm-gpio-blinky-s32k356)
71. [Golioth Bluetooth Data to the Cloud using Pouch](#nxp-appcodehub_dm-ble-cloud)
72. [HTTP Client Get and Post JSON Data](#dm-http-client-get-and-post-json-data)
73. [HTTPS Client/Server Application](#dm-https-client-server)
74. [HTTPS LCD LED Demo](#dm-https-lcd-led-demo)
75. [Hand Gesture Recognition Based on MIMXRT700](#dm-hand-gesture-recognition-based-on-rt700)
76. [Heart rate (BPM) and SPO2 monitoring on FRDM-MCXA153](#dm-frdm-mcxa153-freemaster-heart-rate)
77. [Hello UART Communication Example Using RTD Drivers on FRDM‑A‑S32K356](#dm-uart-hello-s32k356)
78. [How to develop an electric bicycle dashboard design on MCXN947](#dm-frdm-mcxn947-ebike)
79. [How to enable a LVGL cluster demo with i.MX RT1170-EVK.](#dm-lvgl_cluster_rt1170_evk)
80. [How to enable and configure high resolution timestamp on CAN or CAN FD frame reception using KW47-EVK or FRDM-MCXW72 boards.](#dm-can-high-resolution-timestamp-mcxw72-kw47)
81. [How to enable low power in your application on MIMXRT700-EVK](#dm-mimxrt700-evk-dual-core-low-power-thermometer-clock)
82. [How to enable wakeup from Deep Sleep on CAN frame reception using KW47-EVK or FRDM-MCXW72 boards.](#dm-can-low-power-wakeup-mcxw72-kw47)
83. [How to implement USB audio 7.1 channel speaker on MCXN947](#dm-usb-audio-7-1-channel-speaker-on-mcxn947)
84. [How to implement low power on MCXA153](#dm-low-power-implementation-mcxa153)
85. [How to integrate SEGGER SystemView into a KW47 or MCXW 72 device to enable real-time debugging on RTOS based systems](#dm-segger-systemview-integration-mcxw72-kw47)
86. [HyperRAM Multi-Core Access Example](#dm-hyperram-read-write-s32k356)
87. [I3C/I²C-Bus ±0.5 °C Accurate Digital Temperature Sensor with over temperature detection](#dm-p3t175xdp-i2c-13c-temperature-sensor-demo-app)
88. [Implementation of Motor Control Algorithms to MCIMX93-EVK](#dm-motor-control-demo-for-i-mx93)
89. [Industrial Connectivity FRDM-MCXN947 panel](#dm-ip-frdmmcxn947-eth-panel)
90. [Industrial Panel FRDM-MCXN947](#dm-industrial-panel-frdm-mcxn947)
91. [Instrument cluster demo on MIMXRT1170-EVK with Raspberry Pi 7" touch panel, using LVGL](#dm-lvgl_cluster_rt1170_evkb_rpi)
92. [Integrating EdgeLock® A30 secure authenticator to FRDM-MCXA153 board](#dm-a30-mcxa153-ecc-example)
93. [Integrating EdgeLock® SE05X to FRDM-MCX-A development boards](#nano-package_examples_se05x_crypto_mcxa153)
94. [Integrating EdgeLock® SE05X to FRDM-MCX-N development boards](#nano-package_examples_se05x_crypto_mcxn947)
95. [Interactive Button and LED Control with UART Console](#dm-uart-button-s32k312)
96. [Interactive LED Control using Buttons with Messages on UART](#dm-uart-button-s32k118)
97. [Interactive Ping Pong Game Demo Using the MCXN947 Click Shield with OLED C Display and Dual Joystick Click Boards](#dm-mcxn947-click-shield-ping-pong-game)
98. [Internal Temperature Sensing Using AUTOSAR RTD MCAL and FreeMASTER](#dm-adc-tempsense-freemaster-s32k344)
99. [I²C-Bus , 1 Degree C Accuracy, Digital Temperature Sensor ](#dm-pct2075dp-ard-temperature-sensor)
100. [K32W148 BLDC Motor control FreeRTOS application](#dm-bldc-motor-control-k32w148)
101. [KNX IoT Point API stack with ETS support on NXP Connectivity MCUs](#dm-knx-iot-apps-with-ets-support-on-nxp-mcus)
102. [KNX IoT Point API stack with ETS support on NXP Connectivity MCUs running on Zephyr](#dm-knx-iot-zephyr-apps-with-ets-support-on-nxp-mcus)
103. [KNX IoT stack examples running on FRDM-MCXW71](#dm-knx-iot-examples-on-nxp-mcxw71)
104. [KW45: Secure boot scripts based on spsdk](#dm-kw45-secure-boot-scripts)
105. [Knob G Click: multi-platform ecosystem.](#dm-mikroe-knob-g-click-frdm)
106. [LED Brightness Control Using ADC Input and eMIOS PWM with UART Monitoring](#dm-control-led-emios-pwm-adc-uart-s32k356)
107. [LIN Communication Example](#dm-lin-communication-s32k312-s32k344)
108. [LPC55S36 Low End Audio Demo](#dm-lpc55s36-low-end-audio-demo)
109. [LPC55S69 Fashion Mnist Object Recognition](#dm-lpc55s69-fashion-mnist-object-recognition)
110. [LPC55S69 Multi Face Detection](#dm-lpc55s69-multi-face-detection)
111. [Label the CIFAR10 images from the camera on FRDM-MCXN947](#dm-label-cifar10-images-on-mcxn947)
112. [Leveraging deep learning to count the number of people in a room using a low-resolution 8x8 infrared array sensor](#dm-ml-ir-sensor-people-counting)
113. [Low-Power Magnetic Detection With WKPU Peripheral](#dm-reed-low-power-s32k344)
114. [Low-Power Wireless Sensors Examples for MCXW23](#dm-low-power-wireless-sensors-examples-for-mcxw23)
115. [Low-Voltage Translating, 8-Bit I²C-Bus/SMBus I/O Expander](#dm-pcal6408a-8-bit-i2c-gpio-expander)
116. [MCX STREAMDECK](#dm-mcx-streamdeck)
117. [MCXC162 Low Power Presence Detection](#dm-mcxc162-low-power-presence-detection)
118. [MCXC162 Low Power Temperature Sensing](#dm-mcxc162-low-power-temperature-sensing)
119. [MCXC444 LCD display and FXLS8974CF accelerometer motion detection](#dm-mcxc444-lcd-and-fxls8974cf-motion-detection)
120. [MCXN - how to enable the windowed watchdog on low power](#dm-mcxn-windowed-watchdog)
121. [MCXN947 NPU vs Tensorflm Benchmark](#dm-mcxn947-npu-vs-tensorflm-benchmark)
122. [MCXN94x power manager training lab](#dm-mcxn947-power-manager)
123. [MCXW71 Accelerometer and light sensor over Wireless UART](#dm-mcxw71-accel-and-light-ble)
124. [MCXW72 I2S emulation with FlexIO](#dm-mcxw72-i2s-with-flexio)
125. [MCXW72 NAFE13388 4 wire RTD](#dm-mcxw72-nafe13388-4-wire-rtd)
126. [Magnetic Wake-up Example using NMH1000 Magnetic Switch Sensor](#dm-nmh1000-magnetic-switch-example)
127. [Matter BLE channel sounding demonstrator running on MCXW72](#dm-matter-ble-channel-sounding-demonstrator-on-mcxw72)
128. [Matter EVSE demo on FRDM RW612](#dm-matter-evse-demo-on-frdm-rw612)
129. [Matter EdgeLock 2GO secure lock example running on RW612](#dm-matter-secure-lock-on-rw612)
130. [Monitoring Brake Status with Emergency LED Indicator](#dm-brake-status-monitoring-frdm-a-s32k344)
131. [Motion Sensing using FreeMASTER](#dm-motion-sensing-frdm-a-s32k312-freemaster)
132. [Motion and Temperature Sensing using LPI2C and GPIO on FRDM-A-S32K344 with MCAL Drivers](#dm-i2c-gpio-s32k344)
133. [Motion and Temperature Sensing with FreeMASTER](#dm-motion-temperature-freemaster-s32k356)
134. [Motion and temperature monitoring system for FRDM-A-S32K344 using FreeMASTER](#dm-motion-temperature-freemaster-s32k344)
135. [Motion detection using WiFi CSI on RW61x](#dm-motion-detection-using-wifi-csi-on-rw61x)
136. [Motor Control PMSM FRDM with LVGL](#dm-motor-control-pmsm-frdm-mcxa156)
137. [Motor Control PMSM Sensorless dual Shunt FOC](#dm-mc-pmsm-foc-s32k312)
138. [Motor RPM Control with KnobGClick and RPM Display in Real Time with USB](#dm-ip-frdmmcxc444-rotary-motor-update-usb)
139. [Motor RPM Control with KnobGClick with USB](#dm-ip-frdmmcxc242-rotary-motor-update-usb)
140. [Motor RPM Grapher in OLED with USB](#dm-ip-frdmmcxa153-oled-motor-graph-usb)
141. [Multi sensor demo with FRDM-MCXN947 and LDC-PAR-S035](#dm-mcx-accel-and-pressure-monitor)
142. [Multi-Core SD Card Read/Write Using uSDHC](#dm-sd-card-read-write-s32k358)
143. [Multicore Blinking LED Demo for FRDM-A-S32K358](#dm-gpio-blinky-s32k358)
144. [Multicore HyperRAM Read Write Demo](#dm-hyperram-read-write-s32k358)
145. [Multicore Message Passing over LPUART Internal Loopback](#dm-multicore-uart-communication-s32k356)
146. [Multicore SD Card Data Logging](#dm-sd-card-read-write-s32k356)
147. [Multicore UART Communication](#dm-multicore-uart-communication-s32k358)
148. [Multiple Person Detection on MCXN947](#dm-multiple-person-detection-on-mcxn947)
149. [Multiple face detection on mcxn947](#dm-multiple-face-detection-on-mcxn947)
150. [Multistream iperf support on wifi and ethernet interface](#dm-multistream-iperf-support-on-wifi-and-ethernet-interface)
151. [NAFE13388 Universal Analog Sensing Module with Wired Connectivity](#dm-mcxn947-remote-io-with-nafe13388)
152. [NAFE13388-UIM Industrial Applications with GUI and CLI support .](#dm-nafe13388-application-examples)
153. [NAFE33352-UIOM Industrial Applications with GUI support](#dm-nafe33352-application-examples)
154. [NETC: Ethernet Switch Control on M33 with Management Port Sharing via VSIs with A-cores](#dm-imx943-netc-control-and-sharing-between-m33s-acore)
155. [NMH1000 magnetic switch sensor evaluation GUI using ISSDK and FreeMASTER](#dm-freemaster-nmh1000-evaluation-gui-firmware)
156. [NNStreamer Image Classification](#nxp-demo-experience-demos-list_scripts_machine_learning_nnstreamer_classification)
157. [NNStreamer Object Detection](#nxp-demo-experience-demos-list_scripts_machine_learning_nnstreamer_detection)
158. [NXP KM metrology](#dm-nxp-km-metrology)
159. [NXP Platform Accelerator for MCXN947 Freedom Board](#nxp-vee-mcxn947-frdm)
160. [NXP Platform Accelerator for RW612 Freedom](#npa-vee-rw612)
161. [NXP Platform Accelerator for i.MXRT1170 EVK](#nxp-vee-imxrt1170-evk)
162. [NXP Platform Accelerator for i.MXRT595 EVK](#nxp-vee-imxrt595-evk)
163. [Nafe Industrial Application Examples using API Libraries](#dm-nafex388-application-examples)
164. [Near and Far Motion Detection using WiFi CSI on FRDM i.MX 91 + IW610](#dm-csi-based-motion-detection)
165. [OLED Weather Display](#dm-weather-visual-monitor-s32k312)
166. [On device training fan anomaly detection on MCXN947](#dm-on-device-training-fan-anomaly-on-mcxn947)
167. [P3H2X4X : I3C hub demo application on FRDM MCXN947 and MCXA153](#dm-p3h2x4x-i3c-hub-demo-application)
168. [P3T1035xUK - P3T2030xUK - I3C, I2C-bus, 0.5 °C accuracy, digital temperature sensor](#dm-p3t1035xuk-p3t2030xuk-temperature-sensor-i2c-3c-bus-demo-app)
169. [P3T1755: I3C temperature sensor demo](#dm-i3c-temperature-sensor)
170. [PCA9422: PCA9422 Ultra Low Power Charger and Gauge PMIC for RT5/6/700 demo application on FRDM-MCXN947 and MCXA153 ](#dm-pca9422-evb-ultra-low-power-charger-gauge-pmic-demo-app)
171. [PCA9846: Four-Channel Ultra-Low Voltage, Fm+ I2C-Bus Switch with Reset demo application ](#dm-pca9846pw-ard-ultra-low-voltage-fm-plus-i2c-bus-switch-demo-app)
172. [PCA9957HN led driver with demo app running on FRDM-MCXN947 and FRDM-MCXA153](#dm-pca9957hn-led-driver-with-demo-app)
173. [PCA9959HN led driver with demo app running on FRDM-MCXN947 and FRDM-MCXA153](#dm-pca9959hn-led-driver-with-demo-app)
174. [PCAL6416AEV-ARD Low-Voltage Translating 16-Bit I²C-Bus/SMBus I/O Expander](#dm-pcal6416aev-low-voltage-translating-16-bit-i2c-bus-smbus-io-expander)
175. [PCAL6524: Ultra-Low-Voltage Translating 24-Bit  I²C-Bus SMBus IO Expander based GUI demo application](#dm-pcal6524-24-bit-i2c-smbus-io-expander)
176. [PCAL9722: 22-Bit SPI I/O Expander with Agile I/O Features](#dm-pcal9722hn-22-bit-spi-gpio-expander)
177. [PCF2131 : Real Time Clock driver on FRDM-MCXN947.](#dm-pcf2131-real-time-clock-driver-with-demo-app)
178. [PCF85063AT/TP/ATL: Tiny Real Time Clock driver on FRDM-MCXN947 and MCXA153.](#dm-pcf85x63xx-real-time-clock-demo-app)
179. [PCF85063AT/TP: Tiny Real Time Clock driver on FRDM-MCXN947 and MCXA153.](#dm-pcf85063at-tp-real-time-clock-demo-app)
180. [PCF85263ATL-ARD Arduino® Shield - Tiny Real-Time Clock demo application on FRDM -MCXN947 and FRDM-MCXA153](#dm-pcf85263atl-tiny-real-time-clock-demo-application)
181. [PMIC for Low Power Applications on FRDM-MCXN947 and MCXA153](#dm-pca9420uk-evm-pmic-for-low-power-application)
182. [PWM-Based Steering Control for FRDM-A-S32K312](#dm-pwm-steering-frdm-a-s32k312)
183. [Periodic Wakeup via Real-Time Clock with Console Logging](#dm-periodic-timer-wakeup-s32k312)
184. [Persistent User Settings using AUTOSAR MemINFLS](#dm-persistent-settings-s32k358)
185. [Portable Anomaly Detect Demo with FRDM-MCXN947 and FXLS8974CF (ML Vibro Sens Click)](#dm-mcxn-portable-anomaly-detect-demo)
186. [Power Delivery using FRDM-A-S32K344](#dm-power-delivery-frdm-a-s32k344)
187. [Power consumption measurements guide of different power modes on FRDM-MCXW72](#dm-power-consumption-on-mcxw72)
188. [Precision Inclinometer (Bubble Level) with FXLS8971](#dm-mcxn-bubble-level-demo)
189. [Pressure and Altimeter Examples using MPL3115 Sensor](#dm-mpl3115-pressure-altimeter-examples)
190. [QSPI Flash Memory Read/Write demo for FRDM-A-S32K344](#dm-qspi-read-write-s32k344)
191. [Qwiic Accelerometer on FRDM MCU's](#dm-qwiic-accelerometer-frdm)
192. [Qwiic Alphanumeric Display on FRDM MCU's](#dm-qwiic-alphanumeric-display-frdm)
193. [Qwiic Atmospheric on FRDM MCU's](#dm-qwiic-atmospheric-frdm)
194. [Qwiic Joystick on FRDM MCU's](#dm-qwiic-joystick-frdm)
195. [RTC Periodic Wakeup from Standby with UART](#dm-rtc-periodic-wakeup-mcal-s32k344)
196. [RW612 EVSE with J1772, Metrology and OCPP](#dm-ocpp-evse-rw612)
197. [RW612 Wi‑Fi secure MQTT Demonstration](#dm-rw612-wi-fi-secure-mqtt)
198. [RW612-FRDM Door chime demo with MQTT over Wi-Fi and I2S audio output](#dm-rw612frdm-door-chime-demo)
199. [RW612-FRDM Smart AirCon Demo](#dm-frdm-rw612-smart-aircon-demo)
200. [Raw Video Playback Demo for MCX N947](#dm-mcxn947-video-playback)
201. [Read PCT2075DP Temperature I2C Sensor and Send UART Messages](#dm-i2c-temperature-uart-s32k118)
202. [Real-Time Interactive Control with DOOM](#doom-mcx)
203. [Real-Time Temperature Readout Using ADC TempSense and UART](#dm-adc-tempsense-uart-s32k356)
204. [Remote Controlled Relay over Ethernet](#dm-ethernet-oled-relay-s32k344)
205. [SD Card Write to File Example](#dm-sd-card-write-file-s32k358)
206. [SIGBRD-HPGP Board using MCXA154 as an add on board for EV charging solution.](#dm-evse-sigbrd-hpgp)
207. [SJA1124EVB : Quad LIN Commander Transceiver with LIN Commander Controller](#dm-sja1124evb-spi-to-quad-lin-bridge)
208. [Secure Encrypted Ethernet End Nodes](#dm-secure-encrypt-eth-frdm-a-s32k344)
209. [Selfie Segmenter](#nxp-demo-experience-demos-list_scripts_machine_learning_selfie_segmenter)
210. [Serial Communication Using FLEXIO and RTD](#dm-uart-s32k344)
211. [Serial Terminal LED Control Using UART Driver](#dm-uart-button-s32k358)
212. [Servo Steering Control Using PWM](#dm-pwm-steering-control-frdm-a-s32k344)
213. [Simple HTTP Server with Remote Status Observation and Control](#dm-ethernet-server-s32k344)
214. [Smart CAN Gateway for Automotive Actuators](#dm-smart-can-gtwy-frdm-a-s32k312-m276)
215. [Smart Sensing Inhaler using Pressure and Tilt sensors](#dm-smart-sensing-inhaler)
216. [Smart lighting LED bulb using LPC860](#dm-lpc860-smart-lighting)
217. [SmartWatch Zephyr Demo](#apps_zephyr)
218. [Snoring Detection based on RT1060 powered by AI\ML](#dm-snoring-detection-based-on-rt1060)
219. [Standby Mode Wake-Up Using WKPU and GPIO](#dm-gpio-button-wakeup-s32k358)
220. [Startup Message via Serial Terminal Using UART Driver](#dm-uart-hello-s32k358)
221. [Tamper detection with low-power wakeup sensor using BLE wireless UART](#dm-tamper-detection-using-low-power-wakeup-sensor-over-ble)
222. [Temperature Acquisition and UART Reporting](#dm-adc-tempsense-uart-s32k358)
223. [Temperature Sensing and Plotting on FreeMASTER](#dm-adc-tempsense-freemaster-s32k358)
224. [Temperature monitor with Modbus and CAN running in zephyr](#dm-modbus-can-temp-monitor-frdm)
225. [Temperature sensor demo using FRDM-A-S32K344](#dm-temperature-monitor-lcd-frdm-a-s32k344)
226. [Text to Speech with audio playback based on MIMXRT700](#dm-text-to-speech-based-on-rt700)
227. [Thermostat Controller with Relay and UART Reporting](#dm-thermostat-relay-s32k118)
228. [This demo provides APIs to configure and read accurate temperature using P3T1085UK sensor](#dm-p3t1085uk-temperature-sensor-driver-with-demo-app)
229. [This example demonstrates FXLS89xxxF 3-axis accelerometer evaluation GUI using ISSDK and FreeMASTER](#dm-freemaster-fxls89xxxf-evaluation-gui-firmware)
230. [Time Series Studio powered, on-device learning Fan anomaly detection based on FRDM-MCXA156](#dm-tss-powered-on-device-learning-fan-anomaly-based-on-mcxa156)
231. [Touch Keypad Tuning on MCXN](#dm-mcxn-touch-keypad-tuning)
232. [Transmission Control Module On FRDM-A-S32K344](#dm-transmission-control-s32k344)
233. [UART Communication Example using RTD Drivers on FRDM-A-S32K312](#dm-uart-s32k312)
234. [UART Communication and LED Example on FRDM-A-S32K344](#dm-uart-button-s32k344)
235. [UART Status Monitoring with Button Control](#dm-uart-button-s32k356)
236. [UBX100 FreeMASTER evaluation GUI](#dm-ubx100-freemaster-gui)
237. [UBX100 RF toolbox application](#dm-ubx100-rf-toolbox-application)
238. [UBX100 flashloader demo application](#dm-ubx100-flashloader)
239. [UWB Nearby Interaction with phones](#dm-uwb-nearby-interaction-with-phones)
240. [UWB Presence Detection demo](#dm-uwb-presence-detection-demo)
241. [Using EZH to implement camera interface in lpc55 series mcu](#dm-lpc55s69-camera-interface-by-ezh)
242. [Using SmartDMA to implement camera interface in MCXN236](#dm-mcxn236-camera-interface-by-smartdma)
243. [Vehicle Comfort Control for FRDM-A-S32K344](#dm-vehicle-comfort-control-s32k344)
244. [Vehicle Lighting Control for Daylight and Hazard Signals](#dm-vehicle-lighting-signals-frdm-a-s32k344)
245. [Vehicle Lighting Control for Daylight and Hazard Signals on FRDM-A-S32K312](#dm-vehicle-lighting-signals-frdm-a-s32k312)
246. [Very simple serial bootloader for NXP MCU](#dm-nxp_mcu_easy_bootloader)
247. [Visual Heart Rate Monitor](#dm-visual-heart-rate-monitor-s32k312)
248. [Visualizing Sensor Data with FreeMASTER: Motion and Temperature](#dm-motion-temperature-freemaster-s32k358)
249. [Vital Health Signal Visual Monitor On FRDM-A-S32K344](#dm-vital-health-signal-visual-monitor-s32k344)
250. [Wake Up from Sleep Through Magnetic Detection](#dm-reed-low-power-s32k312)
251. [Wake Up from Sleep via GPIO Button Press](#dm-gpio-button-wakeup-s32k344)
252. [Weather Visual Monitor](#dm-weather-visual-monitor-s32k344)
253. [Wi-Fi Easy Connect (DPP) In-Band Provisioning Demo on RT1060EVKC with IW612](#dm-dpp-in-band-provisioning-rt1060-iw612)
254. [Wi-Fi Scan and Connectivity Demo on RW612BGA](#dm-wifi-set-up-ping)
255. [Wi-Fi Sensing using Sniffer on RW61x with Zephyr OS](#dm-wifi-sensing-using-sniffer-on-rw61x-with-zephyr-os)
256. [Wi-Fi connect using LCD interface on FRDM-MCXN947 using Wi-Fi expansion board FRDM-IW416-AW-AM510](#dm-wifi-lcd-connect-frdm-mcxn947)
257. [WiFi AP and BLE Peripheral on RDRW612BGA](#dm-wifi-ap-and-ble-peripheral-on-rdrw612bga)
258. [WiFi CLI M2 FRDM MCXN947](#dm-wifi-cli-frdm-mcxn947)
259. [WiFi provisioning using BLE on RT1170 EVKB using Wi-Fi Module Murata 2EL](#dm-wifi-provisioning-using-ble)
260. [Wireless Co-Processor Enabled Motor Control](#dm-mc-pmsm-ncp-frdm-mcxa156)
261. [Wireless RFTM Application for Performance Testing of RW612 board](#dm-wireless-rf-test-mode-demo)
262. [Wireless uart throughput On RT1060EVKC and IW416](#dm-wireless-uart-throughput-on-rt1060evkc-and-iw416)
263. [Write a file to microSD Card](#dm-sd-card-write-file-s32k356)
264. [[OOBE-MCXW71] Controlling LEDS using BLE Wireless UART](#dm-mcx-wireless-uart-leds)
265. [[RT1060 + IW416] MQTT client using Wi-Fi](#dm-wifi-sta-mqtt)
266. [afci 8ch mcxn547 demo](#dm-afci-8ch-mcxn547)
267. [demo project to use the module sCan](#dm-loc-apps-kw47)
268. [eIQ GenAI Flow Demonstrator](#dm-eiq-genai-flow-demonstrator)
269. [i.MX Driver Monitor System](#nxp-demo-experience-demos-list_scripts_machine_learning_dms)
270. [i.MX Machine Learning Benchmark Tool](#nxp-demo-experience-demos-list_scripts_machine_learning_ml_benchmark)
271. [i.MX RT1170 + NAFE13388 drivers and demos](#dm-nafe_rt1170)
272. [i.MX RT1170 Mirror and control android phone using Zephyr](#dm-i-mx-rt1170-android-phone-screen-mirroring)
273. [i.MX RT1180 based Holoscan Sensor Bridge (HSB)](#dm-rt1180-hsb)
274. [i.MX Smart Fitness](#nxp-demo-experience-demos-list_scripts_machine_learning_imx_smart_fitness)
275. [i.MX Smart Kitchen](#nxp-demo-experience-demos-list_scripts_multimedia_smart_kitchen)
276. [i.MX V4L2 Video Test Tool](#nxp-demo-experience-demos-list_scripts_multimedia_gstreamer_video_test)
277. [i.MX93 Low Power Machine Learning](#nxp-demo-experience-demos-list_scripts_machine_learning_low_power_ml)
278. [i.MX93 Smart Appliance for MATTER](#meta-smart-appliance)
279. [low power measurement on mcxn236](#dm-low-power-measurement-on-mcxn236)
280. [matter zigbee bridge rw612](#dm-matter-zigbee-bridge-rw612)
281. [vital signal monitor](#dm-mcxn947-lcd-heart-rate-spo2)
282. [wolfSSH RGB Server using Zephyr RTOS](#nxp-appcodehub_dm-wolfssh-rgb-server-with-zephyr)
283. [wolfSSL MQTT AWS Test using Zephyr RTOS](#nxp-appcodehub_dm-wolfmqtt-publisher-client-with-zephyr)
284. [wolfSSL TLSv1.3 Hello Server Doing Post-Quantum Cryptography using Zephyr RTOS](#nxp-appcodehub_dm-wolfssl-tls-hello-server-pqc-with-zephyr)
285. [wolfSSL TLSv1.3 Hello Server using Zephyr RTOS](#nxp-appcodehub_dm-wolftpm-wolfssl-tls-with-zephyr)
...
## 15. BLE smart label based on LVGL using Waveshare e-ink display and KW45<a id="dm-lvgl-epaper-smartlabel-kw45"></a> <a href="#top" style="float:right">⤒</a>
...
## 16. BLE throughput measurement on RT1170 EVKB + IW612<a id="dm-ble-throughput-measurement-rt1170"></a> <a href="#top" style="float:right">⤒</a>
...
## 17. Bluetooth LE FSCI Host Application running on FRDM-MCXN947 and MCXW236B-EXP Board<a id="dm-ble-fsci-host-application"></a> <a href="#top" style="float:right">⤒</a>
...
## 18. Bluetooth® Channel Sounding<a id="dm-frdm-mcxw72-channel-sounding-with-oled-b-click"></a> <a href="#top" style="float:right">⤒</a>
...
## 19. Button Press to Wake-Up from Standby and send UART messages<a id="dm-gpio-button-wakeup-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 20. Clea Astarte IoT devices using Zephyr RTOS<a id="astarte-device-sdk-zephyr_samples_astarte_app"></a> <a href="#top" style="float:right">⤒</a>
...
## 21. Clea Edgehog IoT devices using Zephyr RTOS<a id="edgehog-zephyr-device_samples_edgehog_app"></a> <a href="#top" style="float:right">⤒</a>
...
## 22. Control LED Brightness with eMIOS PWM using ADC and UART messaging<a id="dm-control-led-emios-pwm-adc-uart-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 23. Control LED brightness through eMIOS PWM function on FRDM-A-S32K344 using MCAL drivers<a id="dm-control-led-emios-pwm-s32k344-mcal"></a> <a href="#top" style="float:right">⤒</a>
...
## 24. Control LED brightness through eMIOS PWM using MCAL drivers with UART<a id="dm-control-led-emios-pwm-s32k312-mcal"></a> <a href="#top" style="float:right">⤒</a>
...
## 25. Control WS2812 LED intensity with ADC Potentiometer<a id="dm-adc-pot-led-ws2812-intensity-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 26. Controlling LEDs with GPIO<a id="dm-gpio-blinky-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 27. Controlling WS2812 LED Brightness with an Analog Potentiometer<a id="dm-adc-pot-led-ws2812-intensity-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- app-network-ml/. -->
## 28. DeepPacket: Encrypted network packets classification system<a id="app-network-ml"></a> <a href="#top" style="float:right">⤒</a>
...
## 29. Demo and steps creating new Zephyr app repo and custom board<a id="dm-create-zephyr-app-repo"></a> <a href="#top" style="float:right">⤒</a>
...
## 30. Demo for Mikroe Joystick2Click in FRDM with CMSIS driver and GPIO adapter<a id="dm-mikroe-joystick2click-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 31. Demo of MikroE Oled C Click display in FRDM-MCX with CMSIS driver and GPIO adapter<a id="dm-mikroe-oled-c-click-display-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 32. Demo of Mikroe OledBClick in FRDM with CMSIS driver and GPIO adapter<a id="dm-mikroe-oledbclick-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 33. Demo of Mikroe Relay5CLick in FRDM with CMSIS driver and GPIO adapter<a id="dm-mikroe-relay5click-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-lvgl-vit-rt1060/. -->
## 34. Demo of coffee machine using voice recognition (VIT) and LVGL graphics on i.MX RT1060<a id="dm-lvgl-vit-rt1060"></a> <a href="#top" style="float:right">⤒</a>
...
## 35. Door Lock Cluster integration on a Lighting App Matter Application using K32W061 DK6<a id="dm-nxp-k32w061-dk6-door-lock-and-lighting-app-matter-application"></a> <a href="#top" style="float:right">⤒</a>
...
## 36. Driving LCD-PAR-S035 using LVGL on FRM-MCXW71 board<a id="dm-mcxw71-driving-lcd-wireless-uart"></a> <a href="#top" style="float:right">⤒</a>
...
## 37. EVSE-SIG-BRD using LPC5536/LPC55S36 for electric vehicle chargers<a id="dm-lpc5536-evse-sigbrd"></a> <a href="#top" style="float:right">⤒</a>
...
## 38. EZH implements Quad encoder function in lpc5516<a id="dm-lpc55s16-qei-interface-by-ezh"></a> <a href="#top" style="float:right">⤒</a>
...
## 39. EZH implements keyscan function in lpc5516<a id="dm-lpc55s16-keyscan-by-ezh"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- apps_zephyr/. -->
## 40. Edge AI Vision on Zephyr<a id="apps_zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 41. Emergency LED-Based Brake Status Monitoring on FRDM-A-S32K312<a id="dm-brake-control-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 42. Ethernet Communication using FRDM-A-S32K344<a id="dm-high-speed-eth-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 43. Ethernet Frame CRC Validator over UDP<a id="dm-ethernet-crc-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 44. FRDM MCXW72 802.15.4 MAC application with wireless UART support<a id="dm-frdmmcxw72-wireless-uart-15-4-mac-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 46. FRDM-MCXA266 Driving 6 Color ePaper Display with GDEB0709E01 Using LPSPI Quad Mode<a id="dm-mcxa266-6color-epaper-display-using-lpspi-quad-mode"></a> <a href="#top" style="float:right">⤒</a>
...
## 47. FRDM-MCXC162 RGB Rainbow Wheel using CTIMER PWM<a id="dm-frdmmcxc162-rgb-pwm-rainbow-wheel"></a> <a href="#top" style="float:right">⤒</a>
...
## 48. FRDM-MCXC242 Plug-and-Play NFC Controller Enablement with PN7160<a id="dm-mcxc242-pn7160-plug-and-play-nfc-controller"></a> <a href="#top" style="float:right">⤒</a>
...
## 49. FRDM-MCXN947 Sensorless Anomaly Detection for Motor Control System<a id="dm-ml-sensorless-anomaly-detection"></a> <a href="#top" style="float:right">⤒</a>
...
## 50. FRDM-MCXW72 Bluetooth Mesh sensor network on zephyr<a id="dm-frdmmcxw72-bluetooth-mesh-sensor-network-on-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 51. FRDM-MCXW72 LCD-PAR-S035 enablement and control over PMOD<a id="dm-mcxw72-lcd-enablement-over-pmod"></a> <a href="#top" style="float:right">⤒</a>
...
## 52. FRDM-MCXW72 Servo motor control using internal TPM or external PCA9685 controller<a id="dm-frdmmcxw72-servo-motor-multi-control"></a> <a href="#top" style="float:right">⤒</a>
...
## 53. FRDM-MCXW72 Servo motor control using internal TPM or external PCA9685 controller and remote wireless UART commands and LCD GUI<a id="dm-frdmmcxw72-servo-motor-multi-control-with-wireless-uart-and-lcd"></a> <a href="#top" style="float:right">⤒</a>
...
## 54. FRDM-MCXW72 Servo motor multi control with wireless UART on Zephyr<a id="dm-frdmmcxw72-servo-motor-multi-control-with-wireless-uart-on-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 55. FRDM-RW612 GUI Guider integration on Bluetooth LE example<a id="dm-nxp-rw612-gui-guider-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 56. FRDM-RW612 Heart Rate sensor over BLE<a id="dm-frdmrw612-heart-rate-sensor-over-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 57. FRDM-RW612 Matter standalone temperature measurement with on-board sensor<a id="dm-frdm-rw612-matter-standalone-temperature-sensor"></a> <a href="#top" style="float:right">⤒</a>
...
## 58. FRDM-RW612 On-board temperature sensor over BLE<a id="dm-frdmrw612-temperature-sensor-over-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 59. FRDM-RW612 Smart Aircon with Wi-Fi and MQTT<a id="dm-frdm-rw612-smart-aircon-with-wifi-and-mqtt"></a> <a href="#top" style="float:right">⤒</a>
...
## 60. FRDM-RW612 Voice Intelligent Technology on Zephyr RTOS<a id="dm-frdm-rw612-vit-on-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 61. FRDM-RW612 external accelerometer sensor over BLE<a id="dm-frdmrw612-accelerometer-sensor-over-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 62. FRDM33926PNBEVM: Driver and demo app for MC33926 motor controller<a id="dm-frdm33926pnbevm-motor-control-driver-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 64. FRDM‑RW612 Wi‑Fi Access Point to Ethernet Layer‑2 Bridging Demonstration<a id="dm-rw612-wi-fi-ethernet-bridge"></a> <a href="#top" style="float:right">⤒</a>
...
## 65. Fashion MNIST Recognition on MCXN947<a id="dm-fashion-mnist-recognition-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 66. FreeRTOS-Based LittleFS Support on SPI-NAND (W25N01GV) for FRDM-RW612<a id="dm-nand-flash-support-on-frdmrw612"></a> <a href="#top" style="float:right">⤒</a>
...
## 67. Full Appliance Demo<a id="dm-rt1170evkb-full-appliance"></a> <a href="#top" style="float:right">⤒</a>
...
## 68. GPIO Blinking LED Demo for FRDM-A-S32K344<a id="dm-gpio-blinky-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 69. GPIO-Based Wake-Up from Standby Mode on S32K356<a id="dm-gpio-button-wakeup-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 70. Getting Started with Multicore LED Control on FRDM-A-S32K356<a id="dm-gpio-blinky-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 71. Golioth Bluetooth Data to the Cloud using Pouch<a id="nxp-appcodehub_dm-ble-cloud"></a> <a href="#top" style="float:right">⤒</a>
...
## 72. HTTP Client Get and Post JSON Data<a id="dm-http-client-get-and-post-json-data"></a> <a href="#top" style="float:right">⤒</a>
...
## 73. HTTPS Client/Server Application<a id="dm-https-client-server"></a> <a href="#top" style="float:right">⤒</a>
...
## 74. HTTPS LCD LED Demo<a id="dm-https-lcd-led-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 75. Hand Gesture Recognition Based on MIMXRT700<a id="dm-hand-gesture-recognition-based-on-rt700"></a> <a href="#top" style="float:right">⤒</a>
...
## 76. Heart rate (BPM) and SPO2 monitoring on FRDM-MCXA153<a id="dm-frdm-mcxa153-freemaster-heart-rate"></a> <a href="#top" style="float:right">⤒</a>
...
## 77. Hello UART Communication Example Using RTD Drivers on FRDM‑A‑S32K356<a id="dm-uart-hello-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 78. How to develop an electric bicycle dashboard design on MCXN947<a id="dm-frdm-mcxn947-ebike"></a> <a href="#top" style="float:right">⤒</a>
...
## 79. How to enable a LVGL cluster demo with i.MX RT1170-EVK.<a id="dm-lvgl_cluster_rt1170_evk"></a> <a href="#top" style="float:right">⤒</a>
...
## 80. How to enable and configure high resolution timestamp on CAN or CAN FD frame reception using KW47-EVK or FRDM-MCXW72 boards.<a id="dm-can-high-resolution-timestamp-mcxw72-kw47"></a> <a href="#top" style="float:right">⤒</a>
...
## 81. How to enable low power in your application on MIMXRT700-EVK<a id="dm-mimxrt700-evk-dual-core-low-power-thermometer-clock"></a> <a href="#top" style="float:right">⤒</a>
...
## 82. How to enable wakeup from Deep Sleep on CAN frame reception using KW47-EVK or FRDM-MCXW72 boards.<a id="dm-can-low-power-wakeup-mcxw72-kw47"></a> <a href="#top" style="float:right">⤒</a>
...
## 83. How to implement USB audio 7.1 channel speaker on MCXN947<a id="dm-usb-audio-7-1-channel-speaker-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 84. How to implement low power on MCXA153<a id="dm-low-power-implementation-mcxa153"></a> <a href="#top" style="float:right">⤒</a>
...
## 85. How to integrate SEGGER SystemView into a KW47 or MCXW 72 device to enable real-time debugging on RTOS based systems<a id="dm-segger-systemview-integration-mcxw72-kw47"></a> <a href="#top" style="float:right">⤒</a>
...
## 86. HyperRAM Multi-Core Access Example<a id="dm-hyperram-read-write-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 87. I3C/I²C-Bus ±0.5 °C Accurate Digital Temperature Sensor with over temperature detection<a id="dm-p3t175xdp-i2c-13c-temperature-sensor-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 88. Implementation of Motor Control Algorithms to MCIMX93-EVK<a id="dm-motor-control-demo-for-i-mx93"></a> <a href="#top" style="float:right">⤒</a>
...
## 89. Industrial Connectivity FRDM-MCXN947 panel<a id="dm-ip-frdmmcxn947-eth-panel"></a> <a href="#top" style="float:right">⤒</a>
...
## 90. Industrial Panel FRDM-MCXN947<a id="dm-industrial-panel-frdm-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 91. Instrument cluster demo on MIMXRT1170-EVK with Raspberry Pi 7" touch panel, using LVGL<a id="dm-lvgl_cluster_rt1170_evkb_rpi"></a> <a href="#top" style="float:right">⤒</a>
...
## 92. Integrating EdgeLock® A30 secure authenticator to FRDM-MCXA153 board<a id="dm-a30-mcxa153-ecc-example"></a> <a href="#top" style="float:right">⤒</a>
...
## 93. Integrating EdgeLock® SE05X to FRDM-MCX-A development boards<a id="nano-package_examples_se05x_crypto_mcxa153"></a> <a href="#top" style="float:right">⤒</a>
...
## 94. Integrating EdgeLock® SE05X to FRDM-MCX-N development boards<a id="nano-package_examples_se05x_crypto_mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 95. Interactive Button and LED Control with UART Console<a id="dm-uart-button-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 96. Interactive LED Control using Buttons with Messages on UART<a id="dm-uart-button-s32k118"></a> <a href="#top" style="float:right">⤒</a>
...
## 97. Interactive Ping Pong Game Demo Using the MCXN947 Click Shield with OLED C Display and Dual Joystick Click Boards<a id="dm-mcxn947-click-shield-ping-pong-game"></a> <a href="#top" style="float:right">⤒</a>
...
## 98. Internal Temperature Sensing Using AUTOSAR RTD MCAL and FreeMASTER<a id="dm-adc-tempsense-freemaster-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 99. I²C-Bus , 1 Degree C Accuracy, Digital Temperature Sensor <a id="dm-pct2075dp-ard-temperature-sensor"></a> <a href="#top" style="float:right">⤒</a>
...
## 100. K32W148 BLDC Motor control FreeRTOS application<a id="dm-bldc-motor-control-k32w148"></a> <a href="#top" style="float:right">⤒</a>
...
## 101. KNX IoT Point API stack with ETS support on NXP Connectivity MCUs<a id="dm-knx-iot-apps-with-ets-support-on-nxp-mcus"></a> <a href="#top" style="float:right">⤒</a>
...
## 102. KNX IoT Point API stack with ETS support on NXP Connectivity MCUs running on Zephyr<a id="dm-knx-iot-zephyr-apps-with-ets-support-on-nxp-mcus"></a> <a href="#top" style="float:right">⤒</a>
...
## 103. KNX IoT stack examples running on FRDM-MCXW71<a id="dm-knx-iot-examples-on-nxp-mcxw71"></a> <a href="#top" style="float:right">⤒</a>
...
## 105. Knob G Click: multi-platform ecosystem.<a id="dm-mikroe-knob-g-click-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 106. LED Brightness Control Using ADC Input and eMIOS PWM with UART Monitoring<a id="dm-control-led-emios-pwm-adc-uart-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 107. LIN Communication Example<a id="dm-lin-communication-s32k312-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 108. LPC55S36 Low End Audio Demo<a id="dm-lpc55s36-low-end-audio-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 109. LPC55S69 Fashion Mnist Object Recognition<a id="dm-lpc55s69-fashion-mnist-object-recognition"></a> <a href="#top" style="float:right">⤒</a>
...
## 110. LPC55S69 Multi Face Detection<a id="dm-lpc55s69-multi-face-detection"></a> <a href="#top" style="float:right">⤒</a>
...
## 111. Label the CIFAR10 images from the camera on FRDM-MCXN947<a id="dm-label-cifar10-images-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 112. Leveraging deep learning to count the number of people in a room using a low-resolution 8x8 infrared array sensor<a id="dm-ml-ir-sensor-people-counting"></a> <a href="#top" style="float:right">⤒</a>
...
## 113. Low-Power Magnetic Detection With WKPU Peripheral<a id="dm-reed-low-power-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 114. Low-Power Wireless Sensors Examples for MCXW23<a id="dm-low-power-wireless-sensors-examples-for-mcxw23"></a> <a href="#top" style="float:right">⤒</a>
...
## 115. Low-Voltage Translating, 8-Bit I²C-Bus/SMBus I/O Expander<a id="dm-pcal6408a-8-bit-i2c-gpio-expander"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-mcx-streamdeck/. -->
## 116. MCX STREAMDECK<a id="dm-mcx-streamdeck"></a> <a href="#top" style="float:right">⤒</a>
...
## 117. MCXC162 Low Power Presence Detection<a id="dm-mcxc162-low-power-presence-detection"></a> <a href="#top" style="float:right">⤒</a>
...
## 118. MCXC162 Low Power Temperature Sensing<a id="dm-mcxc162-low-power-temperature-sensing"></a> <a href="#top" style="float:right">⤒</a>
...
## 119. MCXC444 LCD display and FXLS8974CF accelerometer motion detection<a id="dm-mcxc444-lcd-and-fxls8974cf-motion-detection"></a> <a href="#top" style="float:right">⤒</a>
...
## 120. MCXN - how to enable the windowed watchdog on low power<a id="dm-mcxn-windowed-watchdog"></a> <a href="#top" style="float:right">⤒</a>
...
## 121. MCXN947 NPU vs Tensorflm Benchmark<a id="dm-mcxn947-npu-vs-tensorflm-benchmark"></a> <a href="#top" style="float:right">⤒</a>
...
## 122. MCXN94x power manager training lab<a id="dm-mcxn947-power-manager"></a> <a href="#top" style="float:right">⤒</a>
...
## 123. MCXW71 Accelerometer and light sensor over Wireless UART<a id="dm-mcxw71-accel-and-light-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 124. MCXW72 I2S emulation with FlexIO<a id="dm-mcxw72-i2s-with-flexio"></a> <a href="#top" style="float:right">⤒</a>
...
## 125. MCXW72 NAFE13388 4 wire RTD<a id="dm-mcxw72-nafe13388-4-wire-rtd"></a> <a href="#top" style="float:right">⤒</a>
...
## 126. Magnetic Wake-up Example using NMH1000 Magnetic Switch Sensor<a id="dm-nmh1000-magnetic-switch-example"></a> <a href="#top" style="float:right">⤒</a>
...
## 127. Matter BLE channel sounding demonstrator running on MCXW72<a id="dm-matter-ble-channel-sounding-demonstrator-on-mcxw72"></a> <a href="#top" style="float:right">⤒</a>
...
## 128. Matter EVSE demo on FRDM RW612<a id="dm-matter-evse-demo-on-frdm-rw612"></a> <a href="#top" style="float:right">⤒</a>
...
## 129. Matter EdgeLock 2GO secure lock example running on RW612<a id="dm-matter-secure-lock-on-rw612"></a> <a href="#top" style="float:right">⤒</a>
...
## 130. Monitoring Brake Status with Emergency LED Indicator<a id="dm-brake-status-monitoring-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 131. Motion Sensing using FreeMASTER<a id="dm-motion-sensing-frdm-a-s32k312-freemaster"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-i2c-gpio-s32k344/. -->
## 132. Motion and Temperature Sensing using LPI2C and GPIO on FRDM-A-S32K344 with MCAL Drivers<a id="dm-i2c-gpio-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 133. Motion and Temperature Sensing with FreeMASTER<a id="dm-motion-temperature-freemaster-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 134. Motion and temperature monitoring system for FRDM-A-S32K344 using FreeMASTER<a id="dm-motion-temperature-freemaster-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 135. Motion detection using WiFi CSI on RW61x<a id="dm-motion-detection-using-wifi-csi-on-rw61x"></a> <a href="#top" style="float:right">⤒</a>
...
## 136. Motor Control PMSM FRDM with LVGL<a id="dm-motor-control-pmsm-frdm-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 137. Motor Control PMSM Sensorless dual Shunt FOC<a id="dm-mc-pmsm-foc-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 138. Motor RPM Control with KnobGClick and RPM Display in Real Time with USB<a id="dm-ip-frdmmcxc444-rotary-motor-update-usb"></a> <a href="#top" style="float:right">⤒</a>
...
## 139. Motor RPM Control with KnobGClick with USB<a id="dm-ip-frdmmcxc242-rotary-motor-update-usb"></a> <a href="#top" style="float:right">⤒</a>
...
## 140. Motor RPM Grapher in OLED with USB<a id="dm-ip-frdmmcxa153-oled-motor-graph-usb"></a> <a href="#top" style="float:right">⤒</a>
...
## 141. Multi sensor demo with FRDM-MCXN947 and LDC-PAR-S035<a id="dm-mcx-accel-and-pressure-monitor"></a> <a href="#top" style="float:right">⤒</a>
...
## 142. Multi-Core SD Card Read/Write Using uSDHC<a id="dm-sd-card-read-write-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 143. Multicore Blinking LED Demo for FRDM-A-S32K358<a id="dm-gpio-blinky-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 144. Multicore HyperRAM Read Write Demo<a id="dm-hyperram-read-write-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 145. Multicore Message Passing over LPUART Internal Loopback<a id="dm-multicore-uart-communication-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 146. Multicore SD Card Data Logging<a id="dm-sd-card-read-write-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 147. Multicore UART Communication<a id="dm-multicore-uart-communication-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 148. Multiple Person Detection on MCXN947<a id="dm-multiple-person-detection-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 149. Multiple face detection on mcxn947<a id="dm-multiple-face-detection-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 150. Multistream iperf support on wifi and ethernet interface<a id="dm-multistream-iperf-support-on-wifi-and-ethernet-interface"></a> <a href="#top" style="float:right">⤒</a>
...
## 151. NAFE13388 Universal Analog Sensing Module with Wired Connectivity<a id="dm-mcxn947-remote-io-with-nafe13388"></a> <a href="#top" style="float:right">⤒</a>
...
## 152. NAFE13388-UIM Industrial Applications with GUI and CLI support .<a id="dm-nafe13388-application-examples"></a> <a href="#top" style="float:right">⤒</a>
...
## 153. NAFE33352-UIOM Industrial Applications with GUI support<a id="dm-nafe33352-application-examples"></a> <a href="#top" style="float:right">⤒</a>
...
## 154. NETC: Ethernet Switch Control on M33 with Management Port Sharing via VSIs with A-cores<a id="dm-imx943-netc-control-and-sharing-between-m33s-acore"></a> <a href="#top" style="float:right">⤒</a>
...
## 155. NMH1000 magnetic switch sensor evaluation GUI using ISSDK and FreeMASTER<a id="dm-freemaster-nmh1000-evaluation-gui-firmware"></a> <a href="#top" style="float:right">⤒</a>
...
## 156. NNStreamer Image Classification<a id="nxp-demo-experience-demos-list_scripts_machine_learning_nnstreamer_classification"></a> <a href="#top" style="float:right">⤒</a>
...
## 157. NNStreamer Object Detection<a id="nxp-demo-experience-demos-list_scripts_machine_learning_nnstreamer_detection"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-nxp-km-metrology/. -->
## 158. NXP KM metrology<a id="dm-nxp-km-metrology"></a> <a href="#top" style="float:right">⤒</a>
...
## 159. NXP Platform Accelerator for MCXN947 Freedom Board<a id="nxp-vee-mcxn947-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- npa-vee-rw612/. -->
## 160. NXP Platform Accelerator for RW612 Freedom<a id="npa-vee-rw612"></a> <a href="#top" style="float:right">⤒</a>
...
## 161. NXP Platform Accelerator for i.MXRT1170 EVK<a id="nxp-vee-imxrt1170-evk"></a> <a href="#top" style="float:right">⤒</a>
...
## 162. NXP Platform Accelerator for i.MXRT595 EVK<a id="nxp-vee-imxrt595-evk"></a> <a href="#top" style="float:right">⤒</a>
...
## 163. Nafe Industrial Application Examples using API Libraries<a id="dm-nafex388-application-examples"></a> <a href="#top" style="float:right">⤒</a>
...
## 164. Near and Far Motion Detection using WiFi CSI on FRDM i.MX 91 + IW610<a id="dm-csi-based-motion-detection"></a> <a href="#top" style="float:right">⤒</a>
...
## 165. OLED Weather Display<a id="dm-weather-visual-monitor-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 166. On device training fan anomaly detection on MCXN947<a id="dm-on-device-training-fan-anomaly-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 167. P3H2X4X : I3C hub demo application on FRDM MCXN947 and MCXA153<a id="dm-p3h2x4x-i3c-hub-demo-application"></a> <a href="#top" style="float:right">⤒</a>
...
## 168. P3T1035xUK - P3T2030xUK - I3C, I2C-bus, 0.5 °C accuracy, digital temperature sensor<a id="dm-p3t1035xuk-p3t2030xuk-temperature-sensor-i2c-3c-bus-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 169. P3T1755: I3C temperature sensor demo<a id="dm-i3c-temperature-sensor"></a> <a href="#top" style="float:right">⤒</a>
...
## 170. PCA9422: PCA9422 Ultra Low Power Charger and Gauge PMIC for RT5/6/700 demo application on FRDM-MCXN947 and MCXA153 <a id="dm-pca9422-evb-ultra-low-power-charger-gauge-pmic-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 171. PCA9846: Four-Channel Ultra-Low Voltage, Fm+ I2C-Bus Switch with Reset demo application <a id="dm-pca9846pw-ard-ultra-low-voltage-fm-plus-i2c-bus-switch-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 172. PCA9957HN led driver with demo app running on FRDM-MCXN947 and FRDM-MCXA153<a id="dm-pca9957hn-led-driver-with-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 173. PCA9959HN led driver with demo app running on FRDM-MCXN947 and FRDM-MCXA153<a id="dm-pca9959hn-led-driver-with-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 174. PCAL6416AEV-ARD Low-Voltage Translating 16-Bit I²C-Bus/SMBus I/O Expander<a id="dm-pcal6416aev-low-voltage-translating-16-bit-i2c-bus-smbus-io-expander"></a> <a href="#top" style="float:right">⤒</a>
...
## 175. PCAL6524: Ultra-Low-Voltage Translating 24-Bit  I²C-Bus SMBus IO Expander based GUI demo application<a id="dm-pcal6524-24-bit-i2c-smbus-io-expander"></a> <a href="#top" style="float:right">⤒</a>
...
## 176. PCAL9722: 22-Bit SPI I/O Expander with Agile I/O Features<a id="dm-pcal9722hn-22-bit-spi-gpio-expander"></a> <a href="#top" style="float:right">⤒</a>
...
## 177. PCF2131 : Real Time Clock driver on FRDM-MCXN947.<a id="dm-pcf2131-real-time-clock-driver-with-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 178. PCF85063AT/TP/ATL: Tiny Real Time Clock driver on FRDM-MCXN947 and MCXA153.<a id="dm-pcf85x63xx-real-time-clock-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 179. PCF85063AT/TP: Tiny Real Time Clock driver on FRDM-MCXN947 and MCXA153.<a id="dm-pcf85063at-tp-real-time-clock-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 180. PCF85263ATL-ARD Arduino® Shield - Tiny Real-Time Clock demo application on FRDM -MCXN947 and FRDM-MCXA153<a id="dm-pcf85263atl-tiny-real-time-clock-demo-application"></a> <a href="#top" style="float:right">⤒</a>
...
## 181. PMIC for Low Power Applications on FRDM-MCXN947 and MCXA153<a id="dm-pca9420uk-evm-pmic-for-low-power-application"></a> <a href="#top" style="float:right">⤒</a>
...
## 182. PWM-Based Steering Control for FRDM-A-S32K312<a id="dm-pwm-steering-frdm-a-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 183. Periodic Wakeup via Real-Time Clock with Console Logging<a id="dm-periodic-timer-wakeup-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 184. Persistent User Settings using AUTOSAR MemINFLS<a id="dm-persistent-settings-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 185. Portable Anomaly Detect Demo with FRDM-MCXN947 and FXLS8974CF (ML Vibro Sens Click)<a id="dm-mcxn-portable-anomaly-detect-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 186. Power Delivery using FRDM-A-S32K344<a id="dm-power-delivery-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 187. Power consumption measurements guide of different power modes on FRDM-MCXW72<a id="dm-power-consumption-on-mcxw72"></a> <a href="#top" style="float:right">⤒</a>
...
## 188. Precision Inclinometer (Bubble Level) with FXLS8971<a id="dm-mcxn-bubble-level-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 189. Pressure and Altimeter Examples using MPL3115 Sensor<a id="dm-mpl3115-pressure-altimeter-examples"></a> <a href="#top" style="float:right">⤒</a>
...
## 190. QSPI Flash Memory Read/Write demo for FRDM-A-S32K344<a id="dm-qspi-read-write-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 191. Qwiic Accelerometer on FRDM MCU's<a id="dm-qwiic-accelerometer-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 192. Qwiic Alphanumeric Display on FRDM MCU's<a id="dm-qwiic-alphanumeric-display-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 193. Qwiic Atmospheric on FRDM MCU's<a id="dm-qwiic-atmospheric-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 194. Qwiic Joystick on FRDM MCU's<a id="dm-qwiic-joystick-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 195. RTC Periodic Wakeup from Standby with UART<a id="dm-rtc-periodic-wakeup-mcal-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-ocpp-evse-rw612/. -->
## 196. RW612 EVSE with J1772, Metrology and OCPP<a id="dm-ocpp-evse-rw612"></a> <a href="#top" style="float:right">⤒</a>
...
## 197. RW612 Wi‑Fi secure MQTT Demonstration<a id="dm-rw612-wi-fi-secure-mqtt"></a> <a href="#top" style="float:right">⤒</a>
...
## 198. RW612-FRDM Door chime demo with MQTT over Wi-Fi and I2S audio output<a id="dm-rw612frdm-door-chime-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 199. RW612-FRDM Smart AirCon Demo<a id="dm-frdm-rw612-smart-aircon-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 200. Raw Video Playback Demo for MCX N947<a id="dm-mcxn947-video-playback"></a> <a href="#top" style="float:right">⤒</a>
...
## 201. Read PCT2075DP Temperature I2C Sensor and Send UART Messages<a id="dm-i2c-temperature-uart-s32k118"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- doom-mcx/. -->
## 202. Real-Time Interactive Control with DOOM<a id="doom-mcx"></a> <a href="#top" style="float:right">⤒</a>
...
## 203. Real-Time Temperature Readout Using ADC TempSense and UART<a id="dm-adc-tempsense-uart-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 204. Remote Controlled Relay over Ethernet<a id="dm-ethernet-oled-relay-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 205. SD Card Write to File Example<a id="dm-sd-card-write-file-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-evse-sigbrd-hpgp/. -->
## 206. SIGBRD-HPGP Board using MCXA154 as an add on board for EV charging solution.<a id="dm-evse-sigbrd-hpgp"></a> <a href="#top" style="float:right">⤒</a>
...
## 207. SJA1124EVB : Quad LIN Commander Transceiver with LIN Commander Controller<a id="dm-sja1124evb-spi-to-quad-lin-bridge"></a> <a href="#top" style="float:right">⤒</a>
...
## 208. Secure Encrypted Ethernet End Nodes<a id="dm-secure-encrypt-eth-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 209. Selfie Segmenter<a id="nxp-demo-experience-demos-list_scripts_machine_learning_selfie_segmenter"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-uart-s32k344/. -->
## 210. Serial Communication Using FLEXIO and RTD<a id="dm-uart-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 211. Serial Terminal LED Control Using UART Driver<a id="dm-uart-button-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 212. Servo Steering Control Using PWM<a id="dm-pwm-steering-control-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 213. Simple HTTP Server with Remote Status Observation and Control<a id="dm-ethernet-server-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 214. Smart CAN Gateway for Automotive Actuators<a id="dm-smart-can-gtwy-frdm-a-s32k312-m276"></a> <a href="#top" style="float:right">⤒</a>
...
## 215. Smart Sensing Inhaler using Pressure and Tilt sensors<a id="dm-smart-sensing-inhaler"></a> <a href="#top" style="float:right">⤒</a>
...
## 216. Smart lighting LED bulb using LPC860<a id="dm-lpc860-smart-lighting"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- apps_zephyr/. -->
## 217. SmartWatch Zephyr Demo<a id="apps_zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 218. Snoring Detection based on RT1060 powered by AI\ML<a id="dm-snoring-detection-based-on-rt1060"></a> <a href="#top" style="float:right">⤒</a>
...
## 219. Standby Mode Wake-Up Using WKPU and GPIO<a id="dm-gpio-button-wakeup-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 220. Startup Message via Serial Terminal Using UART Driver<a id="dm-uart-hello-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 221. Tamper detection with low-power wakeup sensor using BLE wireless UART<a id="dm-tamper-detection-using-low-power-wakeup-sensor-over-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 222. Temperature Acquisition and UART Reporting<a id="dm-adc-tempsense-uart-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 223. Temperature Sensing and Plotting on FreeMASTER<a id="dm-adc-tempsense-freemaster-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 224. Temperature monitor with Modbus and CAN running in zephyr<a id="dm-modbus-can-temp-monitor-frdm"></a> <a href="#top" style="float:right">⤒</a>
...
## 225. Temperature sensor demo using FRDM-A-S32K344<a id="dm-temperature-monitor-lcd-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 226. Text to Speech with audio playback based on MIMXRT700<a id="dm-text-to-speech-based-on-rt700"></a> <a href="#top" style="float:right">⤒</a>
...
## 227. Thermostat Controller with Relay and UART Reporting<a id="dm-thermostat-relay-s32k118"></a> <a href="#top" style="float:right">⤒</a>
...
## 228. This demo provides APIs to configure and read accurate temperature using P3T1085UK sensor<a id="dm-p3t1085uk-temperature-sensor-driver-with-demo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 229. This example demonstrates FXLS89xxxF 3-axis accelerometer evaluation GUI using ISSDK and FreeMASTER<a id="dm-freemaster-fxls89xxxf-evaluation-gui-firmware"></a> <a href="#top" style="float:right">⤒</a>
...
## 230. Time Series Studio powered, on-device learning Fan anomaly detection based on FRDM-MCXA156<a id="dm-tss-powered-on-device-learning-fan-anomaly-based-on-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 231. Touch Keypad Tuning on MCXN<a id="dm-mcxn-touch-keypad-tuning"></a> <a href="#top" style="float:right">⤒</a>
...
## 232. Transmission Control Module On FRDM-A-S32K344<a id="dm-transmission-control-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-uart-s32k312/. -->
## 233. UART Communication Example using RTD Drivers on FRDM-A-S32K312<a id="dm-uart-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 234. UART Communication and LED Example on FRDM-A-S32K344<a id="dm-uart-button-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 235. UART Status Monitoring with Button Control<a id="dm-uart-button-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 236. UBX100 FreeMASTER evaluation GUI<a id="dm-ubx100-freemaster-gui"></a> <a href="#top" style="float:right">⤒</a>
...
## 237. UBX100 RF toolbox application<a id="dm-ubx100-rf-toolbox-application"></a> <a href="#top" style="float:right">⤒</a>
...
## 238. UBX100 flashloader demo application<a id="dm-ubx100-flashloader"></a> <a href="#top" style="float:right">⤒</a>
...
## 239. UWB Nearby Interaction with phones<a id="dm-uwb-nearby-interaction-with-phones"></a> <a href="#top" style="float:right">⤒</a>
...
## 240. UWB Presence Detection demo<a id="dm-uwb-presence-detection-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 241. Using EZH to implement camera interface in lpc55 series mcu<a id="dm-lpc55s69-camera-interface-by-ezh"></a> <a href="#top" style="float:right">⤒</a>
...
## 242. Using SmartDMA to implement camera interface in MCXN236<a id="dm-mcxn236-camera-interface-by-smartdma"></a> <a href="#top" style="float:right">⤒</a>
...
## 243. Vehicle Comfort Control for FRDM-A-S32K344<a id="dm-vehicle-comfort-control-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 244. Vehicle Lighting Control for Daylight and Hazard Signals<a id="dm-vehicle-lighting-signals-frdm-a-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 245. Vehicle Lighting Control for Daylight and Hazard Signals on FRDM-A-S32K312<a id="dm-vehicle-lighting-signals-frdm-a-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 246. Very simple serial bootloader for NXP MCU<a id="dm-nxp_mcu_easy_bootloader"></a> <a href="#top" style="float:right">⤒</a>
...
## 247. Visual Heart Rate Monitor<a id="dm-visual-heart-rate-monitor-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 248. Visualizing Sensor Data with FreeMASTER: Motion and Temperature<a id="dm-motion-temperature-freemaster-s32k358"></a> <a href="#top" style="float:right">⤒</a>
...
## 249. Vital Health Signal Visual Monitor On FRDM-A-S32K344<a id="dm-vital-health-signal-visual-monitor-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 250. Wake Up from Sleep Through Magnetic Detection<a id="dm-reed-low-power-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
## 251. Wake Up from Sleep via GPIO Button Press<a id="dm-gpio-button-wakeup-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 252. Weather Visual Monitor<a id="dm-weather-visual-monitor-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 253. Wi-Fi Easy Connect (DPP) In-Band Provisioning Demo on RT1060EVKC with IW612<a id="dm-dpp-in-band-provisioning-rt1060-iw612"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-wifi-set-up-ping/. -->
## 254. Wi-Fi Scan and Connectivity Demo on RW612BGA<a id="dm-wifi-set-up-ping"></a> <a href="#top" style="float:right">⤒</a>
...
## 255. Wi-Fi Sensing using Sniffer on RW61x with Zephyr OS<a id="dm-wifi-sensing-using-sniffer-on-rw61x-with-zephyr-os"></a> <a href="#top" style="float:right">⤒</a>
...
## 256. Wi-Fi connect using LCD interface on FRDM-MCXN947 using Wi-Fi expansion board FRDM-IW416-AW-AM510<a id="dm-wifi-lcd-connect-frdm-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 257. WiFi AP and BLE Peripheral on RDRW612BGA<a id="dm-wifi-ap-and-ble-peripheral-on-rdrw612bga"></a> <a href="#top" style="float:right">⤒</a>
...
## 258. WiFi CLI M2 FRDM MCXN947<a id="dm-wifi-cli-frdm-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 259. WiFi provisioning using BLE on RT1170 EVKB using Wi-Fi Module Murata 2EL<a id="dm-wifi-provisioning-using-ble"></a> <a href="#top" style="float:right">⤒</a>
...
## 260. Wireless Co-Processor Enabled Motor Control<a id="dm-mc-pmsm-ncp-frdm-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 261. Wireless RFTM Application for Performance Testing of RW612 board<a id="dm-wireless-rf-test-mode-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 262. Wireless uart throughput On RT1060EVKC and IW416<a id="dm-wireless-uart-throughput-on-rt1060evkc-and-iw416"></a> <a href="#top" style="float:right">⤒</a>
...
## 263. Write a file to microSD Card<a id="dm-sd-card-write-file-s32k356"></a> <a href="#top" style="float:right">⤒</a>
...
## 264. [OOBE-MCXW71] Controlling LEDS using BLE Wireless UART<a id="dm-mcx-wireless-uart-leds"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-wifi-sta-mqtt/. -->
## 265. [RT1060 + IW416] MQTT client using Wi-Fi<a id="dm-wifi-sta-mqtt"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-afci-8ch-mcxn547/. -->
## 266. afci 8ch mcxn547 demo<a id="dm-afci-8ch-mcxn547"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-loc-apps-kw47/. -->
## 267. demo project to use the module sCan<a id="dm-loc-apps-kw47"></a> <a href="#top" style="float:right">⤒</a>
...
## 268. eIQ GenAI Flow Demonstrator<a id="dm-eiq-genai-flow-demonstrator"></a> <a href="#top" style="float:right">⤒</a>
...
## 269. i.MX Driver Monitor System<a id="nxp-demo-experience-demos-list_scripts_machine_learning_dms"></a> <a href="#top" style="float:right">⤒</a>
...
## 270. i.MX Machine Learning Benchmark Tool<a id="nxp-demo-experience-demos-list_scripts_machine_learning_ml_benchmark"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-nafe_rt1170/. -->
## 271. i.MX RT1170 + NAFE13388 drivers and demos<a id="dm-nafe_rt1170"></a> <a href="#top" style="float:right">⤒</a>
...
## 272. i.MX RT1170 Mirror and control android phone using Zephyr<a id="dm-i-mx-rt1170-android-phone-screen-mirroring"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- dm-rt1180-hsb/. -->
## 273. i.MX RT1180 based Holoscan Sensor Bridge (HSB)<a id="dm-rt1180-hsb"></a> <a href="#top" style="float:right">⤒</a>
...
## 274. i.MX Smart Fitness<a id="nxp-demo-experience-demos-list_scripts_machine_learning_imx_smart_fitness"></a> <a href="#top" style="float:right">⤒</a>
...
## 275. i.MX Smart Kitchen<a id="nxp-demo-experience-demos-list_scripts_multimedia_smart_kitchen"></a> <a href="#top" style="float:right">⤒</a>
...
## 276. i.MX V4L2 Video Test Tool<a id="nxp-demo-experience-demos-list_scripts_multimedia_gstreamer_video_test"></a> <a href="#top" style="float:right">⤒</a>
...
## 277. i.MX93 Low Power Machine Learning<a id="nxp-demo-experience-demos-list_scripts_machine_learning_low_power_ml"></a> <a href="#top" style="float:right">⤒</a>
...
## 278. i.MX93 Smart Appliance for MATTER<a id="meta-smart-appliance"></a> <a href="#top" style="float:right">⤒</a>
...
## 279. low power measurement on mcxn236<a id="dm-low-power-measurement-on-mcxn236"></a> <a href="#top" style="float:right">⤒</a>
...
## 280. matter zigbee bridge rw612<a id="dm-matter-zigbee-bridge-rw612"></a> <a href="#top" style="float:right">⤒</a>
...
## 281. vital signal monitor<a id="dm-mcxn947-lcd-heart-rate-spo2"></a> <a href="#top" style="float:right">⤒</a>
...
## 282. wolfSSH RGB Server using Zephyr RTOS<a id="nxp-appcodehub_dm-wolfssh-rgb-server-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 283. wolfSSL MQTT AWS Test using Zephyr RTOS<a id="nxp-appcodehub_dm-wolfmqtt-publisher-client-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 284. wolfSSL TLSv1.3 Hello Server Doing Post-Quantum Cryptography using Zephyr RTOS<a id="nxp-appcodehub_dm-wolfssl-tls-hello-server-pqc-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
...
## 285. wolfSSL TLSv1.3 Hello Server using Zephyr RTOS<a id="nxp-appcodehub_dm-wolftpm-wolfssl-tls-with-zephyr"></a> <a href="#top" style="float:right">⤒</a>
