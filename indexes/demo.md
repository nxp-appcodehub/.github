...
9. [Raw Video Playback Demo for MCX N947](#dm-mcxn947-video-playback)
10. [MCXN94x power manager training lab](#dm-mcxn947-power-manager)
11. [On device training fan anomaly detection on MCXN947](#dm-on-device-training-fan-anomaly-on-mcxn947)
12. [MCXN - how to enable the windowed watchdog on low power](#dm-mcxn-windowed-watchdog)
13. [Label the CIFAR10 images from the camera on FRDM-MCXN947](#dm-label-cifar10-images-on-mcxn947)
14. [MCXN947 NPU vs Tensorflm Benchmark](#dm-mcxn947-npu-vs-tensorflm-benchmark)
15. [How to implement USB audio 7.1 channel speaker on MCXN947](#dm-usb-audio-7-1-channel-speaker-on-mcxn947)
16. [How to develop an electric bicycle dashboard design on MCXN947](#dm-frdm-mcxn947-ebike)
17. [Fashion MNIST Recognition on MCXN947](#dm-fashion-mnist-recognition-on-mcxn947)
18. [Multiple face detection on mcxn947](#dm-multiple-face-detection-on-mcxn947)
19. [How to implement low power on MCXA153](#dm-low-power-implementation-mcxa153)
20. [Multiple Person Detection on MCXN947](#dm-multiple-person-detection-on-mcxn947)
21. [Heart rate (BPM) and SPO2 monitoring on FRDM-MCXA153](#dm-frdm-mcxa153-freemaster-heart-rate)
22. [Industrial Panel FRDM-MCXN947](#dm-industrial-panel-frdm-mcxn947)
23. [MCX STREAMDECK](#dm-mcx-streamdeck)
24. [vital signal monitor](#dm-mcxn947-lcd-heart-rate-spo2)
...
## 9. Raw Video Playback Demo for MCX N947<a name="dm-mcxn947-video-playback"></a>
### Overview
...
## 10. MCXN94x power manager training lab<a name="dm-mcxn947-power-manager"></a>
### Overview
...
## 11. On device training fan anomaly detection on MCXN947<a name="dm-on-device-training-fan-anomaly-on-mcxn947"></a>
### Overview
...
## 12. MCXN - how to enable the windowed watchdog on low power<a name="dm-mcxn-windowed-watchdog"></a>
### Overview
...
## 13. Label the CIFAR10 images from the camera on FRDM-MCXN947<a name="dm-label-cifar10-images-on-mcxn947"></a>
### Overview
...
## 14. MCXN947 NPU vs Tensorflm Benchmark<a name="dm-mcxn947-npu-vs-tensorflm-benchmark"></a>
### Overview
...
## 15. How to implement USB audio 7.1 channel speaker on MCXN947<a name="dm-usb-audio-7-1-channel-speaker-on-mcxn947"></a>
### Overview
...
## 16. How to develop an electric bicycle dashboard design on MCXN947<a name="dm-frdm-mcxn947-ebike"></a>
### Overview
...
## 17. Fashion MNIST Recognition on MCXN947<a name="dm-fashion-mnist-recognition-on-mcxn947"></a>
### Overview
...
## 18. Multiple face detection on mcxn947<a name="dm-multiple-face-detection-on-mcxn947"></a>
### Overview
...
## 19. How to implement low power on MCXA153<a name="dm-low-power-implementation-mcxa153"></a>
### Overview
...
## 20. Multiple Person Detection on MCXN947<a name="dm-multiple-person-detection-on-mcxn947"></a>
### Overview
...
## 21. Heart rate (BPM) and SPO2 monitoring on FRDM-MCXA153<a name="dm-frdm-mcxa153-freemaster-heart-rate"></a>
### Overview
...
## 22. Industrial Panel FRDM-MCXN947<a name="dm-industrial-panel-frdm-mcxn947"></a>
### Overview
...
<!-- dm-mcx-streamdeck -->
## 23. MCX STREAMDECK<a name="dm-mcx-streamdeck"></a>
### Overview
...
## 24. vital signal monitor<a name="dm-mcxn947-lcd-heart-rate-spo2"></a>
### Overview
