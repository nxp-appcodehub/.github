...
3. [AN12126: Using LPC802 as an I2C I/O expander](#an-lpc802_io_expander)
4. [AN12125: Using LPC802 as I2C-bus EEPROM](#an-lpc802_io_eeprom)
5. [multiple-usb-audio-formats-on-lpc5500](#an-multiple-usb-audio-formats-on-lpc5500)
6. [AN13437: Triggering ADC multi-channel conversion via low power interrupt timer on KE17Z](#an-ftm_lpit_adc12_multi_channel)
7. [LPC55S36_mc_bldc_wHall](#an-lpc55s36_mc_bldc_whall)
8. [AN13730: Developing a GUI on a memory constrained MCU with GUI Guider and LVGL](#an-lvgl_demo_for_small_mcu)
9. [AN13778: Porting VGLite driver for bare metal or single task](#an-vglite_porting_imxrt)
10. [AN13075：i.MX RT1170 heterogeneous graphics pipeline](#an-graphics_features_rt1170)
11. [AN13768: LCD display On/Off switching in low-power mode on i.MX RT1170](#an-display_low_power_rt1170)
12. [flexio_camera_rt1010](#an-flexio_camera_rt1010)
13. [AN12110: Developing a camera application with i.MX RT series](#an-hd_camera_rt1050)
14. [AN12103: Simple USB video class device on i.MX RT1050](#an-uvc_imxrt)
15. [AN13498: PowerQuad digital signal processing on NXP LPC553x/LPC55S3x](#an-dsp_for_lpc553x_using_pq)
16. [DRM174: Totem-pole power factor correction using MC56F81xxx](#an-tppfc_mc56f8xxxx)
17. [DRM172: Half bridge LLC converter based on MC56F81xxx](#an-hbllc_mc56f8xxxx)
18. [AN13184: 3-phase PMSM sensorless vector control and 2-phase interleaved PFC on MC56F83783](#an-mc_pfc_56f83783)
19. [AN12822: Emulation of 8080 bus via FlexIO on RT1050](#an-flexio_8080_rt1050)
20. [lpc_uart_server](#an-lpc_uart_server)
21. [AN13496: Computing FFT with PowerQuad and CMSIS-DSP on LPC5500](#an-fft_with_pq_and_cmsis_dsp)
22. [AN13497: Firmware update using secondary bootloader](#an-fw_update_using_sec_bootloader)
23. [mipi-dsi-screen-pushing-rt500](#an-mipi-dsi-screen-pushing-rt500)
24. [AN12004: Low-Power Motion Wake-Up Examples for FXLS8974CF using Sensor Data Change Detection (SDCD) Block](#an-fxls8974cf-low-power-wake-up-examples)
25. [MCX N PLU setup and usage](#an-mcxn-plu-setupandusage)
26. [AN14099: PMSM Sensorless FOC Using MCXA153](#an-pmsm-foc-mcxa153)
27. [USB to CAN-FD Adaptor based on MCXN Microcontroller](#an-usb-to-can-adaptor-mcxn947)
28. [Using the Real Time Clock (RTC) on MCX](#an-mcx-rtc-example)
29. [Sensorless BLDC motor control on MCXA153](#an-mc-bldc-mcxa153)
30. [Sensorless BLDC motor control on KE17Z](#an-mc-bldc-ke17z)
31. [AN13864: Smart Battery Charger by LPC865 with SMBus Interface](#an-smart-battery-charger-lpc86x)
32. [How to emulate UART with IRDA by using FlexIO](#an-flexio-emulating-uart-with-irda)
33. [How to use In-System Programming (ISP) on FRDM-RW612](#an-frdmrw612-in-system-programming)
34. [USB to Multi VCOM on MCXC444 Series MCU](#an-usb-to-multi-vcom-on-mcxc444)
35. [Using SLCD controller on MCXC444 MCU](#an-using-slcd-controller-on-mcxc444)
36. [XIP from external NOR flash and configuring external pSRAM using multiport FlexSPI module](#an-xip-external-nor-flash-plus-external-psram)
37. [Migration guide from FRDM-RW612 to third-party module memories](#an-frdmrw612-module-migration-guide)
38. [AN14191: How to Use SmartDMA to Implement Camera Interface in MCXN MCU](#an-mcxn947-camera-interface-by-smartdma)
39. [AN14184 Using SmartDMA for Keyscan on MCX N Series MCU](#an-mcxn947-keyscan-interface-by-smartdma)
40. [How to use FlexIO state mode to generate center aligned PWM on MCXN Series MCU](#an-using-flexio-to-generate-center-aligned-pwm-on-mcxn947)
41. [AN14354: Multimode bidirectional AC-DC converter design using MC56F83783](#an-bidirectional-acdc-mc56f83783)
42. [AN14333: Bidirectional Resonant DC-DC Converter Design using MC56F83783](#an-bidirectional-dcdc-mc56f83783)
43. [AN14017 Permanent Magnet Synchronous Motors One-shunt Control Using LPC86x](#an-pmsm-one-shunt-lpc86x)
44. [AN13953 Integrating NFC Reader Library in a KW4x Bluetooth Low Energy Application](#an-kw4x-bluetooth-le-nfc-integration)
45. [AN14434 How to implement MCXN236 USB to I3C demo](#an-mcxn236-usb-bridge-to-i3c)
46. [How to use SmartMDA to implement MDIO slave interface on MCX MCU](#an-mcxn947-mdio-slave-interface-by-smartdma)
47. [AN14018: Sensorless Brushless DC(BLDC) Motor Control on LPC86x](#an-mc-bldc-lpc86x)
48. [emulating i2s bus with flexio on mcxa156](#an-emulating-i2s-bus-with-flexio-on-mcxa156)
49. [How to running RT-Thread on MCUXpressoIDE](#an-running-rtthread-on-mcuxpressoide)
50. [How to use ctimer to generate center aligned PWM in MCX MCU](#an-mcxn947-ctimer-center-aligned-pwm)
51. [AN14619: PMSM sensorless one shunt FOC on MCX A](#an-mc-pmsm-one-shunt-mcxa153)
52. [AN12149: Implementing an IEEE 1588 V2 on i.MX RT  Using PTPd, FreeRTOS, and lwIP TCP/IP  stack](#an-ethernet-lwip-ptpd-imxrt)
53. [AN14605 Using the RTC OSC Calibration Feature of the LPC5500](#an-lpc55s69-rtc-osc-calibration)
54. [AN14619: PMSM sensorless one shunt FOC on MCX A](#an-mc-pmsm-one-shunt-mcxa346)
55. [AN14619: PMSM sensorless one shunt FOC on MCX A](#an-mc-pmsm-one-shunt-mcxa156)
56. [AN14717: Dual PMSM FOC on MCX A](#an-mc-pmsm-dual-mcxa346)
57. [AN14729 Getting Started with EdgeLock Accelerator(CSEC) on MCX E24x](#an-mcxe24x-csec-getting-started)
58. [AN14617 Features and Operation Modes of FlexTimer Module on MCXE24x](#an-mcxe24x-flextimer-example)
59. [AN14616: Sensorless Field oriented Control (FOC) on MCXE24x](#an-mc-pmsm-mcxe247)
60. [AN14765 Low Power Implementation on MCXA345/346](#an-mcxa346-low-power-implementation)
61. [AN14754 Using MCXE247 QuadSPI Module](#an-using-mcxe247-quadspi-module)
62. [AN14797 3-Phase PMSM Field-Oriented Control Solution using MCX E31B](#an-mc-pmsm-mcxe31b)
63. [How to implment tamagawa protocol on MCXE31](#an-digital-encoder-tamagawa-on-mcx31)
...
## 3. AN12126: Using LPC802 as an I2C I/O expander<a id="an-lpc802_io_expander"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-lpc802_io_eeprom/. -->
## 4. AN12125: Using LPC802 as I2C-bus EEPROM<a id="an-lpc802_io_eeprom"></a> <a href="#top" style="float:right">⤒</a>
...
## 6. AN13437: Triggering ADC multi-channel conversion via low power interrupt timer on KE17Z<a id="an-ftm_lpit_adc12_multi_channel"></a> <a href="#top" style="float:right">⤒</a>
...
## 7. LPC55S36_mc_bldc_wHall<a id="an-lpc55s36_mc_bldc_whall"></a> <a href="#top" style="float:right">⤒</a>
...
## 8. AN13730: Developing a GUI on a memory constrained MCU with GUI Guider and LVGL<a id="an-lvgl_demo_for_small_mcu"></a> <a href="#top" style="float:right">⤒</a>
...
## 9. AN13778: Porting VGLite driver for bare metal or single task<a id="an-vglite_porting_imxrt"></a> <a href="#top" style="float:right">⤒</a>
...
## 11. AN13768: LCD display On/Off switching in low-power mode on i.MX RT1170<a id="an-display_low_power_rt1170"></a> <a href="#top" style="float:right">⤒</a>
...
## 12. flexio_camera_rt1010<a id="an-flexio_camera_rt1010"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-hd_camera_rt1050/. -->
## 13. AN12110: Developing a camera application with i.MX RT series<a id="an-hd_camera_rt1050"></a> <a href="#top" style="float:right">⤒</a>
...
## 15. AN13498: PowerQuad digital signal processing on NXP LPC553x/LPC55S3x<a id="an-dsp_for_lpc553x_using_pq"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-tppfc_mc56f8xxxx/. -->
## 16. DRM174: Totem-pole power factor correction using MC56F81xxx<a id="an-tppfc_mc56f8xxxx"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-hbllc_mc56f8xxxx/. -->
## 17. DRM172: Half bridge LLC converter based on MC56F81xxx<a id="an-hbllc_mc56f8xxxx"></a> <a href="#top" style="float:right">⤒</a>
...
## 19. AN12822: Emulation of 8080 bus via FlexIO on RT1050<a id="an-flexio_8080_rt1050"></a> <a href="#top" style="float:right">⤒</a>
...
## 21. AN13496: Computing FFT with PowerQuad and CMSIS-DSP on LPC5500<a id="an-fft_with_pq_and_cmsis_dsp"></a> <a href="#top" style="float:right">⤒</a>
...
## 22. AN13497: Firmware update using secondary bootloader<a id="an-fw_update_using_sec_bootloader"></a> <a href="#top" style="float:right">⤒</a>
...
## 23. mipi-dsi-screen-pushing-rt500<a id="an-mipi-dsi-screen-pushing-rt500"></a> <a href="#top" style="float:right">⤒</a>
...
## 24. AN12004: Low-Power Motion Wake-Up Examples for FXLS8974CF using Sensor Data Change Detection (SDCD) Block<a id="an-fxls8974cf-low-power-wake-up-examples"></a> <a href="#top" style="float:right">⤒</a>
...
## 25. MCX N PLU setup and usage<a id="an-mcxn-plu-setupandusage"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-pmsm-foc-mcxa153/. -->
## 26. AN14099: PMSM Sensorless FOC Using MCXA153<a id="an-pmsm-foc-mcxa153"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mcx-rtc-example/. -->
## 28. Using the Real Time Clock (RTC) on MCX<a id="an-mcx-rtc-example"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-bldc-mcxa153/. -->
## 29. Sensorless BLDC motor control on MCXA153<a id="an-mc-bldc-mcxa153"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-bldc-ke17z/. -->
## 30. Sensorless BLDC motor control on KE17Z<a id="an-mc-bldc-ke17z"></a> <a href="#top" style="float:right">⤒</a>
...
## 31. AN13864: Smart Battery Charger by LPC865 with SMBus Interface<a id="an-smart-battery-charger-lpc86x"></a> <a href="#top" style="float:right">⤒</a>
...
## 32. How to emulate UART with IRDA by using FlexIO<a id="an-flexio-emulating-uart-with-irda"></a> <a href="#top" style="float:right">⤒</a>
...
## 33. How to use In-System Programming (ISP) on FRDM-RW612<a id="an-frdmrw612-in-system-programming"></a> <a href="#top" style="float:right">⤒</a>
...
## 34. USB to Multi VCOM on MCXC444 Series MCU<a id="an-usb-to-multi-vcom-on-mcxc444"></a> <a href="#top" style="float:right">⤒</a>
...
## 35. Using SLCD controller on MCXC444 MCU<a id="an-using-slcd-controller-on-mcxc444"></a> <a href="#top" style="float:right">⤒</a>
...
## 36. XIP from external NOR flash and configuring external pSRAM using multiport FlexSPI module<a id="an-xip-external-nor-flash-plus-external-psram"></a> <a href="#top" style="float:right">⤒</a>
...
## 38. AN14191: How to Use SmartDMA to Implement Camera Interface in MCXN MCU<a id="an-mcxn947-camera-interface-by-smartdma"></a> <a href="#top" style="float:right">⤒</a>
...
## 39. AN14184 Using SmartDMA for Keyscan on MCX N Series MCU<a id="an-mcxn947-keyscan-interface-by-smartdma"></a> <a href="#top" style="float:right">⤒</a>
...
## 40. How to use FlexIO state mode to generate center aligned PWM on MCXN Series MCU<a id="an-using-flexio-to-generate-center-aligned-pwm-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 41. AN14354: Multimode bidirectional AC-DC converter design using MC56F83783<a id="an-bidirectional-acdc-mc56f83783"></a> <a href="#top" style="float:right">⤒</a>
...
## 42. AN14333: Bidirectional Resonant DC-DC Converter Design using MC56F83783<a id="an-bidirectional-dcdc-mc56f83783"></a> <a href="#top" style="float:right">⤒</a>
...
## 43. AN14017 Permanent Magnet Synchronous Motors One-shunt Control Using LPC86x<a id="an-pmsm-one-shunt-lpc86x"></a> <a href="#top" style="float:right">⤒</a>
...
## 44. AN13953 Integrating NFC Reader Library in a KW4x Bluetooth Low Energy Application<a id="an-kw4x-bluetooth-le-nfc-integration"></a> <a href="#top" style="float:right">⤒</a>
...
## 45. AN14434 How to implement MCXN236 USB to I3C demo<a id="an-mcxn236-usb-bridge-to-i3c"></a> <a href="#top" style="float:right">⤒</a>
...
## 46. How to use SmartMDA to implement MDIO slave interface on MCX MCU<a id="an-mcxn947-mdio-slave-interface-by-smartdma"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-bldc-lpc86x/. -->
## 47. AN14018: Sensorless Brushless DC(BLDC) Motor Control on LPC86x<a id="an-mc-bldc-lpc86x"></a> <a href="#top" style="float:right">⤒</a>
...
## 48. emulating i2s bus with flexio on mcxa156<a id="an-emulating-i2s-bus-with-flexio-on-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 49. How to running RT-Thread on MCUXpressoIDE<a id="an-running-rtthread-on-mcuxpressoide"></a> <a href="#top" style="float:right">⤒</a>
...
## 50. How to use ctimer to generate center aligned PWM in MCX MCU<a id="an-mcxn947-ctimer-center-aligned-pwm"></a> <a href="#top" style="float:right">⤒</a>
...
## 51. AN14619: PMSM sensorless one shunt FOC on MCX A<a id="an-mc-pmsm-one-shunt-mcxa153"></a> <a href="#top" style="float:right">⤒</a>
...
## 52. AN12149: Implementing an IEEE 1588 V2 on i.MX RT  Using PTPd, FreeRTOS, and lwIP TCP/IP  stack<a id="an-ethernet-lwip-ptpd-imxrt"></a> <a href="#top" style="float:right">⤒</a>
...
## 53. AN14605 Using the RTC OSC Calibration Feature of the LPC5500<a id="an-lpc55s69-rtc-osc-calibration"></a> <a href="#top" style="float:right">⤒</a>
...
## 54. AN14619: PMSM sensorless one shunt FOC on MCX A<a id="an-mc-pmsm-one-shunt-mcxa346"></a> <a href="#top" style="float:right">⤒</a>
...
## 55. AN14619: PMSM sensorless one shunt FOC on MCX A<a id="an-mc-pmsm-one-shunt-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 56. AN14717: Dual PMSM FOC on MCX A<a id="an-mc-pmsm-dual-mcxa346"></a> <a href="#top" style="float:right">⤒</a>
...
## 57. AN14729 Getting Started with EdgeLock Accelerator(CSEC) on MCX E24x<a id="an-mcxe24x-csec-getting-started"></a> <a href="#top" style="float:right">⤒</a>
...
## 58. AN14617 Features and Operation Modes of FlexTimer Module on MCXE24x<a id="an-mcxe24x-flextimer-example"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-pmsm-mcxe247/. -->
## 59. AN14616: Sensorless Field oriented Control (FOC) on MCXE24x<a id="an-mc-pmsm-mcxe247"></a> <a href="#top" style="float:right">⤒</a>
...
## 60. AN14765 Low Power Implementation on MCXA345/346<a id="an-mcxa346-low-power-implementation"></a> <a href="#top" style="float:right">⤒</a>
...
## 61. AN14754 Using MCXE247 QuadSPI Module<a id="an-using-mcxe247-quadspi-module"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-pmsm-mcxe31b/. -->
## 62. AN14797 3-Phase PMSM Field-Oriented Control Solution using MCX E31B<a id="an-mc-pmsm-mcxe31b"></a> <a href="#top" style="float:right">⤒</a>
...
## 63. How to implment tamagawa protocol on MCXE31<a id="an-digital-encoder-tamagawa-on-mcx31"></a> <a href="#top" style="float:right">⤒</a>
