...
51. [CAN Communication using FRDM-A-S32K312](#an-canfd-to-canfd-secnode-s32k312)
52. [DRM172: Half bridge LLC converter based on MC56F81xxx](#an-hbllc_mc56f8xxxx)
53. [DRM174: Totem-pole power factor correction using MC56F81xxx](#an-tppfc_mc56f8xxxx)
54. [How to emulate UART with IRDA by using FlexIO](#an-flexio-emulating-uart-with-irda)
55. [How to implement low power on MCXA156](#an-low-power-implementation-mcxa156)
56. [How to implment tamagawa protocol on MCXE31](#an-digital-encoder-tamagawa-on-mcx31)
57. [How to running RT-Thread on MCUXpressoIDE](#an-running-rtthread-on-mcuxpressoide)
58. [How to use FlexIO state mode to generate center aligned PWM on MCXN Series MCU](#an-using-flexio-to-generate-center-aligned-pwm-on-mcxn947)
59. [How to use In-System Programming (ISP) on FRDM-RW612](#an-frdmrw612-in-system-programming)
60. [How to use SmartMDA to implement MDIO slave interface on MCX MCU](#an-mcxn947-mdio-slave-interface-by-smartdma)
61. [How to use ctimer to generate center aligned PWM in MCX MCU](#an-mcxn947-ctimer-center-aligned-pwm)
62. [MCX N PLU setup and usage](#an-mcxn-plu-setupandusage)
63. [Migration guide from FRDM-RW612 to third-party module memories](#an-frdmrw612-module-migration-guide)
64. [PMSM Motor Control Sensorless dual Shunt FOC on FRDM-A-S32K344](#an-mc-pmsm-foc-2sh-s32k344)
65. [SR250 UWB Plug-and-Play Application](#an-sr250-uwb-plug-and-play-demo)
66. [Sensorless BLDC motor control on KE17Z](#an-mc-bldc-ke17z)
67. [Sensorless BLDC motor control on MCXA153](#an-mc-bldc-mcxa153)
68. [USB to CAN-FD Adaptor based on MCXN Microcontroller](#an-usb-to-can-adaptor-mcxn947)
69. [USB to Multi VCOM on MCXC444 Series MCU](#an-usb-to-multi-vcom-on-mcxc444)
...
## 51. CAN Communication using FRDM-A-S32K312<a id="an-canfd-to-canfd-secnode-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-hbllc_mc56f8xxxx/. -->
## 52. DRM172: Half bridge LLC converter based on MC56F81xxx<a id="an-hbllc_mc56f8xxxx"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-tppfc_mc56f8xxxx/. -->
## 53. DRM174: Totem-pole power factor correction using MC56F81xxx<a id="an-tppfc_mc56f8xxxx"></a> <a href="#top" style="float:right">⤒</a>
...
## 55. How to implement low power on MCXA156<a id="an-low-power-implementation-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 57. How to running RT-Thread on MCUXpressoIDE<a id="an-running-rtthread-on-mcuxpressoide"></a> <a href="#top" style="float:right">⤒</a>
...
## 58. How to use FlexIO state mode to generate center aligned PWM on MCXN Series MCU<a id="an-using-flexio-to-generate-center-aligned-pwm-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 59. How to use In-System Programming (ISP) on FRDM-RW612<a id="an-frdmrw612-in-system-programming"></a> <a href="#top" style="float:right">⤒</a>
...
## 60. How to use SmartMDA to implement MDIO slave interface on MCX MCU<a id="an-mcxn947-mdio-slave-interface-by-smartdma"></a> <a href="#top" style="float:right">⤒</a>
...
## 61. How to use ctimer to generate center aligned PWM in MCX MCU<a id="an-mcxn947-ctimer-center-aligned-pwm"></a> <a href="#top" style="float:right">⤒</a>
...
## 62. MCX N PLU setup and usage<a id="an-mcxn-plu-setupandusage"></a> <a href="#top" style="float:right">⤒</a>
...
## 63. Migration guide from FRDM-RW612 to third-party module memories<a id="an-frdmrw612-module-migration-guide"></a> <a href="#top" style="float:right">⤒</a>
...
## 64. PMSM Motor Control Sensorless dual Shunt FOC on FRDM-A-S32K344<a id="an-mc-pmsm-foc-2sh-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 65. SR250 UWB Plug-and-Play Application<a id="an-sr250-uwb-plug-and-play-demo"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-bldc-ke17z/. -->
## 66. Sensorless BLDC motor control on KE17Z<a id="an-mc-bldc-ke17z"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-bldc-mcxa153/. -->
## 67. Sensorless BLDC motor control on MCXA153<a id="an-mc-bldc-mcxa153"></a> <a href="#top" style="float:right">⤒</a>
...
## 68. USB to CAN-FD Adaptor based on MCXN Microcontroller<a id="an-usb-to-can-adaptor-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 69. USB to Multi VCOM on MCXC444 Series MCU<a id="an-usb-to-multi-vcom-on-mcxc444"></a> <a href="#top" style="float:right">⤒</a>
...
## 70. Using SLCD controller on MCXC444 MCU<a id="an-using-slcd-controller-on-mcxc444"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mcx-rtc-example/. -->
## 71. Using the Real Time Clock (RTC) on MCX<a id="an-mcx-rtc-example"></a> <a href="#top" style="float:right">⤒</a>
...
## 72. XIP from external NOR flash and configuring external pSRAM using multiport FlexSPI module<a id="an-xip-external-nor-flash-plus-external-psram"></a> <a href="#top" style="float:right">⤒</a>
