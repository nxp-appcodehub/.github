...
## Index
1. [flexio_camera_rt1010](#an-flexio_camera_rt1010)
2. [LPC55S36_mc_bldc_wHall](#an-lpc55s36_mc_bldc_whall)
...
39. [AN14619: PMSM sensorless one shunt FOC on MCX A](#an-mc-pmsm-one-shunt-mcxa153)
40. [AN14619: PMSM sensorless one shunt FOC on MCX A](#an-mc-pmsm-one-shunt-mcxa156)
41. [AN14619: PMSM sensorless one shunt FOC on MCX A](#an-mc-pmsm-one-shunt-mcxa346)
42. [AN14717: Dual PMSM FOC on MCX A](#an-mc-pmsm-dual-mcxa346)
43. [AN14729 Getting Started with EdgeLock Accelerator(CSEC) on MCX E24x](#an-mcxe24x-csec-getting-started)
44. [AN14754 Using MCXE247 QuadSPI Module](#an-using-mcxe247-quadspi-module)
45. [AN14765 Low Power Implementation on MCXA345/346](#an-mcxa346-low-power-implementation)
...
49. [AN14961 PMSM control with ADC shunt current measurement on i.MX 943](#an-mc-pmsm-adc-imx943)
50. [AN14980 Emulating WS2812 bus with FlexIO on MCXA366](#an-emulating-ws2812-bus-with-flexio-on-mcx366)
51. [AN14996 - Integrating Wi-Fi EasyMesh in a Yocto Environment with Live Topology Dashboard](#an-wifi-easymesh)
52. [AN15137: Implementing an IEEE 1588 V2 on MCX A577 Using PTPd, FreeRTOS, and lwIP TCP/IP stack](#an-ethernet-lwip-ptpd-on-mcxa577)
53. [CAN Communication using FRDM-A-S32K312](#an-canfd-to-canfd-secnode-s32k312)
54. [DRM172: Half bridge LLC converter based on MC56F81xxx](#an-hbllc_mc56f8xxxx)
55. [DRM174: Totem-pole power factor correction using MC56F81xxx](#an-tppfc_mc56f8xxxx)
56. [How to emulate UART with IRDA by using FlexIO](#an-flexio-emulating-uart-with-irda)
57. [How to implement low power on MCXA156](#an-low-power-implementation-mcxa156)
58. [How to implment tamagawa protocol on MCXE31](#an-digital-encoder-tamagawa-on-mcx31)
59. [How to running RT-Thread on MCUXpressoIDE](#an-running-rtthread-on-mcuxpressoide)
60. [How to use FlexIO state mode to generate center aligned PWM on MCXN Series MCU](#an-using-flexio-to-generate-center-aligned-pwm-on-mcxn947)
61. [How to use In-System Programming (ISP) on FRDM-RW612](#an-frdmrw612-in-system-programming)
62. [How to use SmartMDA to implement MDIO slave interface on MCX MCU](#an-mcxn947-mdio-slave-interface-by-smartdma)
63. [How to use ctimer to generate center aligned PWM in MCX MCU](#an-mcxn947-ctimer-center-aligned-pwm)
64. [MCX N PLU setup and usage](#an-mcxn-plu-setupandusage)
65. [Migration guide from FRDM-RW612 to third-party module memories](#an-frdmrw612-module-migration-guide)
66. [PMSM Motor Control Sensorless dual Shunt FOC](#an-mc-pmsm-foc-2sh-s32k344)
67. [SR250 UWB Plug-and-Play Application](#an-sr250-uwb-plug-and-play-demo)
68. [Sensorless BLDC motor control on KE17Z](#an-mc-bldc-ke17z)
69. [Sensorless BLDC motor control on MCXA153](#an-mc-bldc-mcxa153)
70. [USB to CAN-FD Adaptor based on MCXN Microcontroller](#an-usb-to-can-adaptor-mcxn947)
71. [USB to Multi VCOM on MCXC444 Series MCU](#an-usb-to-multi-vcom-on-mcxc444)
72. [Using SLCD controller on MCXC444 MCU](#an-using-slcd-controller-on-mcxc444)
73. [Using the Real Time Clock (RTC) on MCX](#an-mcx-rtc-example)
74. [XIP from external NOR flash and configuring external pSRAM using multiport FlexSPI module](#an-xip-external-nor-flash-plus-external-psram)
75. [continuous SRAM address usage on MCXA15x](#an-continuous-sram-address-mcxa15x)
76. [emulating i2s bus with flexio on mcxa156](#an-emulating-i2s-bus-with-flexio-on-mcxa156)
...
## 2. LPC55S36_mc_bldc_wHall<a id="an-lpc55s36_mc_bldc_whall"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-lpc_uart_server/. -->
## 3. lpc_uart_server<a id="an-lpc_uart_server"></a> <a href="#top" style="float:right">⤒</a>
...
## 4. mipi-dsi-screen-pushing-rt500<a id="an-mipi-dsi-screen-pushing-rt500"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-pmsm-mcxe247/. -->
## 37. AN14616: Sensorless Field oriented Control (FOC) on MCXE24x<a id="an-mc-pmsm-mcxe247"></a> <a href="#top" style="float:right">⤒</a>
...
## 38. AN14617 Features and Operation Modes of FlexTimer Module on MCXE24x<a id="an-mcxe24x-flextimer-example"></a> <a href="#top" style="float:right">⤒</a>
...
## 39. AN14619: PMSM sensorless one shunt FOC on MCX A<a id="an-mc-pmsm-one-shunt-mcxa153"></a> <a href="#top" style="float:right">⤒</a>
...
## 40. AN14619: PMSM sensorless one shunt FOC on MCX A<a id="an-mc-pmsm-one-shunt-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
## 41. AN14619: PMSM sensorless one shunt FOC on MCX A<a id="an-mc-pmsm-one-shunt-mcxa346"></a> <a href="#top" style="float:right">⤒</a>
...
## 42. AN14717: Dual PMSM FOC on MCX A<a id="an-mc-pmsm-dual-mcxa346"></a> <a href="#top" style="float:right">⤒</a>
...
## 44. AN14754 Using MCXE247 QuadSPI Module<a id="an-using-mcxe247-quadspi-module"></a> <a href="#top" style="float:right">⤒</a>
...
## 45. AN14765 Low Power Implementation on MCXA345/346<a id="an-mcxa346-low-power-implementation"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-pmsm-mcxe31b/. -->
## 46. AN14797 3-Phase PMSM Field-Oriented Control Solution using MCX E31B<a id="an-mc-pmsm-mcxe31b"></a> <a href="#top" style="float:right">⤒</a>
...
## 47. AN14856 MPPT demo based on MCX A346<a id="an-mcxa346-mppt-demo"></a> <a href="#top" style="float:right">⤒</a>
...
## 48. AN14860 Using Segment Liquid Crystal Displays (SLCD) Controller on MCX A Series<a id="an-mcxa366-slcd-example"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-pmsm-adc-imx943/. -->
## 49. AN14961 PMSM control with ADC shunt current measurement on i.MX 943<a id="an-mc-pmsm-adc-imx943"></a> <a href="#top" style="float:right">⤒</a>

### Overview
Implementation of advanced motor control algorithms using the IMX943-EVK with EnDat2.2 and EnDat3 absolute encoder support. This application demonstrates Field-Oriented Control (FOC), sensorless Back-EMF observer, and multiple control modes including position, speed, current, and scalar control.
...
#### **Repository URL:** https://github.com/NXP-APPCODEHUB/an-mc-pmsm-adc-imx943/tree/main
#### **ACH URL:**        https://mcuxpresso.nxp.com/appcodehub?search=an-mc-pmsm-adc-imx943

<!-- an-emulating-ws2812-bus-with-flexio-on-mcx366/. -->
## 50. AN14980 Emulating WS2812 bus with FlexIO on MCXA366<a id="an-emulating-ws2812-bus-with-flexio-on-mcx366"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-wifi-easymesh/. -->
## 51. AN14996 - Integrating Wi-Fi EasyMesh in a Yocto Environment with Live Topology Dashboard<a id="an-wifi-easymesh"></a> <a href="#top" style="float:right">⤒</a>

### Overview
This repository contains the Python backend server and JavaScript frontend for hosting a live web-based GUI that visualizes the EasyMesh network topology. EasyMesh is part of the NXP BSP package. Tested on FRDM-IMX93 with IW612. Compatible with any i.MX board that supports EasyMesh. Refer to AN14996 for the full Yocto build, network bring-up, and configuration procedure.<br />

#### Families:           i.MX 
#### Toolchains:         GCC 
#### Peripherals:        Wi-Fi 
#### Categories:         Networking, Wireless Connectivity 
...
#### **Repository URL:** https://github.com/NXP-APPCODEHUB/an-wifi-easymesh/tree/main
#### **ACH URL:**        https://mcuxpresso.nxp.com/appcodehub?search=an-wifi-easymesh

<!-- an-ethernet-lwip-ptpd-on-mcxa577/. -->
## 52. AN15137: Implementing an IEEE 1588 V2 on MCX A577 Using PTPd, FreeRTOS, and lwIP TCP/IP stack<a id="an-ethernet-lwip-ptpd-on-mcxa577"></a> <a href="#top" style="float:right">⤒</a>

### Overview
This application note describes how to implement the Ethernet 1588 PTPd protocol on the MCX A577.
...
#### **Repository URL:** https://github.com/NXP-APPCODEHUB/an-ethernet-lwip-ptpd-on-mcxa577/tree/main
#### **ACH URL:**        https://mcuxpresso.nxp.com/appcodehub?search=an-ethernet-lwip-ptpd-on-mcxa577

<!-- an-canfd-to-canfd-secnode-s32k312/. -->
## 53. CAN Communication using FRDM-A-S32K312<a id="an-canfd-to-canfd-secnode-s32k312"></a> <a href="#top" style="float:right">⤒</a>
...
</pre>TX Node Mode (CAN_TX_NODE): Periodically transmits CAN frames (standard/extended IDs supported) with configurable payloads and timing. <br /><br />RX Node Mode (CAN_RX_NODE): Listens on the CAN bus, filters frames by ID/mask. <br /><br />Loopback Mode (CAN_LOOPBACK_MODE): Enables controller internal loopback to validate CAN initialization, bitrate, filters, and ISR paths without external bus hardware, providing a fast self‑test for bring‑up.
...
#### **Repository URL:** https://github.com/NXP-APPCODEHUB/an-canfd-to-canfd-secnode-s32k312/tree/main
#### **ACH URL:**        https://mcuxpresso.nxp.com/appcodehub?search=an-canfd-to-canfd-secnode-s32k312

<!-- an-hbllc_mc56f8xxxx/. -->
## 54. DRM172: Half bridge LLC converter based on MC56F81xxx<a id="an-hbllc_mc56f8xxxx"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-tppfc_mc56f8xxxx/. -->
## 55. DRM174: Totem-pole power factor correction using MC56F81xxx<a id="an-tppfc_mc56f8xxxx"></a> <a href="#top" style="float:right">⤒</a>
...
## 56. How to emulate UART with IRDA by using FlexIO<a id="an-flexio-emulating-uart-with-irda"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-low-power-implementation-mcxa156/. -->
## 57. How to implement low power on MCXA156<a id="an-low-power-implementation-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
...
#### **Repository URL:** https://github.com/NXP-APPCODEHUB/an-low-power-implementation-mcxa156/tree/main
#### **ACH URL:**        https://mcuxpresso.nxp.com/appcodehub?search=an-low-power-implementation-mcxa156

<!-- an-digital-encoder-tamagawa-on-mcx31/. -->
## 58. How to implment tamagawa protocol on MCXE31<a id="an-digital-encoder-tamagawa-on-mcx31"></a> <a href="#top" style="float:right">⤒</a>
...
## 59. How to running RT-Thread on MCUXpressoIDE<a id="an-running-rtthread-on-mcuxpressoide"></a> <a href="#top" style="float:right">⤒</a>
...
## 60. How to use FlexIO state mode to generate center aligned PWM on MCXN Series MCU<a id="an-using-flexio-to-generate-center-aligned-pwm-on-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 61. How to use In-System Programming (ISP) on FRDM-RW612<a id="an-frdmrw612-in-system-programming"></a> <a href="#top" style="float:right">⤒</a>
...
## 62. How to use SmartMDA to implement MDIO slave interface on MCX MCU<a id="an-mcxn947-mdio-slave-interface-by-smartdma"></a> <a href="#top" style="float:right">⤒</a>
...
## 63. How to use ctimer to generate center aligned PWM in MCX MCU<a id="an-mcxn947-ctimer-center-aligned-pwm"></a> <a href="#top" style="float:right">⤒</a>
...
## 64. MCX N PLU setup and usage<a id="an-mcxn-plu-setupandusage"></a> <a href="#top" style="float:right">⤒</a>
...
## 65. Migration guide from FRDM-RW612 to third-party module memories<a id="an-frdmrw612-module-migration-guide"></a> <a href="#top" style="float:right">⤒</a>
...
## 66. PMSM Motor Control Sensorless dual Shunt FOC<a id="an-mc-pmsm-foc-2sh-s32k344"></a> <a href="#top" style="float:right">⤒</a>
...
## 67. SR250 UWB Plug-and-Play Application<a id="an-sr250-uwb-plug-and-play-demo"></a> <a href="#top" style="float:right">⤒</a>
...
#### **Repository URL:** https://github.com/NXP-APPCODEHUB/an-sr250-uwb-plug-and-play-demo/tree/main
#### **ACH URL:**        https://mcuxpresso.nxp.com/appcodehub?search=an-sr250-uwb-plug-and-play-demo

<!-- an-mc-bldc-ke17z/. -->
## 68. Sensorless BLDC motor control on KE17Z<a id="an-mc-bldc-ke17z"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mc-bldc-mcxa153/. -->
## 69. Sensorless BLDC motor control on MCXA153<a id="an-mc-bldc-mcxa153"></a> <a href="#top" style="float:right">⤒</a>
...
## 70. USB to CAN-FD Adaptor based on MCXN Microcontroller<a id="an-usb-to-can-adaptor-mcxn947"></a> <a href="#top" style="float:right">⤒</a>
...
## 71. USB to Multi VCOM on MCXC444 Series MCU<a id="an-usb-to-multi-vcom-on-mcxc444"></a> <a href="#top" style="float:right">⤒</a>
...
## 72. Using SLCD controller on MCXC444 MCU<a id="an-using-slcd-controller-on-mcxc444"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- an-mcx-rtc-example/. -->
## 73. Using the Real Time Clock (RTC) on MCX<a id="an-mcx-rtc-example"></a> <a href="#top" style="float:right">⤒</a>
...
## 74. XIP from external NOR flash and configuring external pSRAM using multiport FlexSPI module<a id="an-xip-external-nor-flash-plus-external-psram"></a> <a href="#top" style="float:right">⤒</a>
...
## 75. continuous SRAM address usage on MCXA15x<a id="an-continuous-sram-address-mcxa15x"></a> <a href="#top" style="float:right">⤒</a>
...
## 76. emulating i2s bus with flexio on mcxa156<a id="an-emulating-i2s-bus-with-flexio-on-mcxa156"></a> <a href="#top" style="float:right">⤒</a>
