...
2. [Basic Matter Ready Connected HMI platform with cost-optimized MCU, Wi-Fi 4, Thread, and Bluetooth Low Energy 5.0](#ap-basic-matter-ready-connected-hmi)
3. [Buspal Application for FRDM MCX Families](#ap-frdm-mcx-buspal)
4. [Conversa Voice Calling Software Pack](#ap-conversa-voice-calling)
5. [DVS With Internal PVT Sensor](#ap-dvs-pvt-sensor)
6. [FRDM MCXW71 Matter light &amp; switch app Thread end device solution](#ap-frdm-mcxw71-light-switch-combo-app)
7. [FRDM RW612 Matter light &amp; switch app plus Thread Border Router solution](#ap-frdm-rw612-light-switch-otbr-combo)
8. [ML State Monitor](#ap-ml-state-monitor)
9. [ML Universal Datalogger for FreeMASTER](#ap-ml-universal-datalogger-for-freemaster)
10. [Power Optimized Voice UI](#ap-optimized-voice-ui)
11. [i.MX RT INDUSTRIAL DRIVE DEVELOPMENT PLATFORM](#ap-qmc2g-industrial)
...
## 2. Basic Matter Ready Connected HMI platform with cost-optimized MCU, Wi-Fi 4, Thread, and Bluetooth Low Energy 5.0<a id="ap-basic-matter-ready-connected-hmi"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- ap-frdm-mcx-buspal/. -->
## 3. Buspal Application for FRDM MCX Families<a id="ap-frdm-mcx-buspal"></a> <a href="#top" style="float:right">⤒</a>
...
## 4. Conversa Voice Calling Software Pack<a id="ap-conversa-voice-calling"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- ap-dvs-pvt-sensor/. -->
## 5. DVS With Internal PVT Sensor<a id="ap-dvs-pvt-sensor"></a> <a href="#top" style="float:right">⤒</a>
...
## 6. FRDM MCXW71 Matter light &amp; switch app Thread end device solution<a id="ap-frdm-mcxw71-light-switch-combo-app"></a> <a href="#top" style="float:right">⤒</a>
...
## 7. FRDM RW612 Matter light &amp; switch app plus Thread Border Router solution<a id="ap-frdm-rw612-light-switch-otbr-combo"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- ap-ml-state-monitor/. -->
## 8. ML State Monitor<a id="ap-ml-state-monitor"></a> <a href="#top" style="float:right">⤒</a>
...
## 9. ML Universal Datalogger for FreeMASTER<a id="ap-ml-universal-datalogger-for-freemaster"></a> <a href="#top" style="float:right">⤒</a>
...
## 10. Power Optimized Voice UI<a id="ap-optimized-voice-ui"></a> <a href="#top" style="float:right">⤒</a>
...
<!-- ap-qmc2g-industrial/. -->
## 11. i.MX RT INDUSTRIAL DRIVE DEVELOPMENT PLATFORM<a id="ap-qmc2g-industrial"></a> <a href="#top" style="float:right">⤒</a>
