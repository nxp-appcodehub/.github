...
## Index
1. [NXP EasyEVSE iMXRT106x](#rd-nxp-easyevse-imxrt106x)
2. [How to set up the motion control reference design on iMX.RT1180](#rd-motion-control-slave-servo-mimxrt1180)
...
## 1. NXP EasyEVSE iMXRT106x<a id="rd-nxp-easyevse-imxrt106x"></a> <a href="#top" style="float:right">⤒</a>
...
## 2. How to set up the motion control reference design on iMX.RT1180<a id="rd-motion-control-slave-servo-mimxrt1180"></a> <a href="#top" style="float:right">⤒</a>
